...
/*      DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
      ...
      /*@lineinfo:generated-code*//*@lineinfo:73^7*/ /*//  *************************************************************//*//  #sql { call TBPBD_DEL_TBSALDOS(:v_fecha_contrato,:v_contrato,:v_producto, :v_cod_err, :v_men_err) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN TBPBD_DEL_TBSALDOS( :1  , :2  , :3  ,  :4  ,  :5  )\n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"0TBPKT_UTILIDADES.TBPKT_VALOR_UNIDAD.SQL_CALCULO_VALOR_UNIDAD",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(4,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(5,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(1,v_fecha_contrato); __sJT_st.setString(2,v_contrato); __sJT_st.setString(3,v_producto); __sJT_st.setInt(4,v_cod_err); __sJT_st.setString(5,v_men_err); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_cod_err = __sJT_st.getInt(4); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_men_err = (String)__sJT_st.getString(5); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:73^115*/
      if (v_cod_err != 0){
        v_salida[0] = 0;
        v_salida[1] = 0;
...
//          #sql v_saldo_contrato ={values (TBCL_AS400.TBF_SALDO_CONTRATO(:v_contrato,:v_fecha_contrato))};
    ...
    ( String v_fecha_contrato, String v_fecha_unidad, String v_contrato, String v_producto, boolean v_update,  AS400 as400, String v_libreria)
  {
    ...
    try{
      ...
      /* Borrar los saldos mayores a la fecha de contrato enviada existentes en
         TBSALDOS para evitar los caLculos erroneos originados por los BACK DATE */
      /*@lineinfo:generated-code*//*@lineinfo:243^7*/ /*//  *************************************************************//*//  #sql { call TBPBD_DEL_TBSALDOS(:v_fecha_contrato,:v_contrato,:v_producto, :v_cod_err, :v_men_err) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN TBPBD_DEL_TBSALDOS( :1  , :2  , :3  ,  :4  ,  :5  )\n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"5TBPKT_UTILIDADES.TBPKT_VALOR_UNIDAD.SQL_CALCULO_VALOR_UNIDAD",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(4,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(5,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(1,v_fecha_contrato); __sJT_st.setString(2,v_contrato); __sJT_st.setString(3,v_producto); __sJT_st.setInt(4,v_cod_err); __sJT_st.setString(5,v_men_err); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_cod_err = __sJT_st.getInt(4); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_men_err = (String)__sJT_st.getString(5); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:243^115*/
      if (v_cod_err != 0){
        v_salida[0] = 0;
        v_salida[1] = 0;
        v_salida[2] = v_cod_err;
        ...
        if (v_cod_err == 0){
          ...
          if (v_saldo_contrato > 0 ){
            ...
            //Seleccionar los saldos de unidades y cuenta contingente a la maxima
            //fecha en TBSALDOS
            /*@lineinfo:generated-code*//*@lineinfo:283^13*/ /*//  *************************************************************//*//  #sql { call TBPBD_ULTIMOS_SALDOS(:v_fecha_contrato,             :v_contrato,*//*//                                              :v_producto,                   :v_max_fecha,*//*//                                              :v_saldo_unidad_max_fec,   :v_cuenta_conting_max_fec,*//*//                                              :v_cod_err,              :v_men_err) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN TBPBD_ULTIMOS_SALDOS( :1  ,              :2  ,\n                                             :3  ,                    :4  ,\n                                             :5  ,    :6  ,\n                                             :7  ,               :8  )\n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"6TBPKT_UTILIDADES.TBPKT_VALOR_UNIDAD.SQL_CALCULO_VALOR_UNIDAD",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(4,oracle.jdbc.OracleTypes.DATE); __sJT_st.registerOutParameter(5,oracle.jdbc.OracleTypes.DOUBLE); __sJT_st.registerOutParameter(6,oracle.jdbc.OracleTypes.DOUBLE); __sJT_st.registerOutParameter(7,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(8,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(1,v_fecha_contrato); __sJT_st.setString(2,v_contrato); __sJT_st.setString(3,v_producto); __sJT_st.setInt(7,v_cod_err); __sJT_st.setString(8,v_men_err); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_max_fecha = (java.sql.Date)__sJT_st.getDate(4); v_saldo_unidad_max_fec = __sJT_st.getDouble(5); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_cuenta_conting_max_fec = __sJT_st.getDouble(6); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_cod_err = __sJT_st.getInt(7); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_men_err = (String)__sJT_st.getString(8); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ 
            ...
            //y retornar el codigo de error sino seguir con el calculo de unidades a la fecha deseada
            if (v_cod_err == 0){
              /*@lineinfo:generated-code*//*@lineinfo:290^15*/ /*//  *************************************************************//*//  #sql v_saldo_unidades = { values (TBFBD_CALC_SALDO_UNIDAD_P(:v_fecha_unidad,*//*//                                                                           :v_contrato,*//*//                                                                           :v_producto,*//*//                                                                           :v_max_fecha,*//*//                                                                           :v_saldo_unidad_max_fec,*//*//                                                                           :v_cod_err,*//*//                                                                           :v_men_err)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TBFBD_CALC_SALDO_UNIDAD_P( :2  ,\n                                                                          :3  ,\n                                                                          :4  ,\n                                                                          :5  ,\n                                                                          :6  ,\n                                                                          :7  ,\n                                                                          :8  ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"7TBPKT_UTILIDADES.TBPKT_VALOR_UNIDAD.SQL_CALCULO_VALOR_UNIDAD",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.DOUBLE); __sJT_st.registerOutParameter(7,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(8,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_fecha_unidad); __sJT_st.setString(3,v_contrato); __sJT_st.setString(4,v_producto); __sJT_st.setDate(5,v_max_fecha); __sJT_st.setDouble(6,v_saldo_unidad_max_fec); __sJT_st.setInt(7,v_cod_err); __sJT_st.setString(8,v_men_err); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_saldo_unidades = __sJT_st.getDouble(1); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_cod_err = __sJT_st.getInt(7); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_men_err = (String)__sJT_st.getString(8); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ 
           ...
           System.out.println("v_saldo_unidades "+v_saldo_unidades);
              ...
              if (v_cod_err == 0){
                ...
                if (v_saldo_unidades > 0 ){
                  ...
                  if (v_update){
                    //Llama al procedimiento que inserta en la tabla TBSALDOS
                    /*@lineinfo:generated-code*//*@lineinfo:310^21*/ /*//  *************************************************************//*//  #sql { call TBPBD_INS_TBSALDOS(:v_producto,       :v_contrato,*//*//                                                    :v_fecha_contrato, :v_saldo_contrato,*//*//                                                    null,              null,*//*//                                                    :v_saldo_unidades, :v_valor_unidad,*//*//                                                    :v_cod_err,  :v_men_err) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN TBPBD_INS_TBSALDOS( :1  ,        :2  ,\n                                                   :3  ,  :4  ,\n                                                  null,              null,\n                                                   :5  ,  :6  ,\n                                                   :7  ,   :8  )\n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"8TBPKT_UTILIDADES.TBPKT_VALOR_UNIDAD.SQL_CALCULO_VALOR_UNIDAD",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(7,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(8,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(1,v_producto); __sJT_st.setString(2,v_contrato); __sJT_st.setString(3,v_fecha_contrato); __sJT_st.setDouble(4,v_saldo_contrato); __sJT_st.setDouble(5,v_saldo_unidades); __sJT_st.setDouble(6,v_valor_unidad); __sJT_st.setInt(7,v_cod_err); __sJT_st.setString(8,v_men_err); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_cod_err = __sJT_st.getInt(7); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_men_err = (String)__sJT_st.getString(8); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ 
                    ...
                    if (v_cod_err == -0001){
                      v_cod_err = 0;
                      /*@lineinfo:generated-code*//*@lineinfo:318^23*/ /*//  *************************************************************//*//  #sql { call TBPBD_UPDATE_SALDOS(to_date(:v_fecha_contrato,'RRRR-MM-DD'),*//*//                                                       :v_producto,*//*//                                                       :v_contrato,*//*//                                                       :v_saldo_contrato,*//*//                                                       null,*//*//                                                       null,*//*//                                                       :v_saldo_unidades,*//*//                                                       :v_valor_unidad,*//*//                                                       :v_cod_err,*//*//                                                       :v_men_err) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN TBPBD_UPDATE_SALDOS(to_date( :1  ,'RRRR-MM-DD'),\n                                                      :2  ,\n                                                      :3  ,\n                                                      :4  ,\n                                                     null,\n                                                     null,\n                                                      :5  ,\n                                                      :6  ,\n                                                      :7  ,\n                                                      :8  )\n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"9TBPKT_UTILIDADES.TBPKT_VALOR_UNIDAD.SQL_CALCULO_VALOR_UNIDAD",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(7,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(8,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(1,v_fecha_contrato); __sJT_st.setString(2,v_producto); __sJT_st.setString(3,v_contrato); __sJT_st.setDouble(4,v_saldo_contrato); __sJT_st.setDouble(5,v_saldo_unidades); __sJT_st.setDouble(6,v_valor_unidad); __sJT_st.setInt(7,v_cod_err); __sJT_st.setString(8,v_men_err); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_cod_err = __sJT_st.getInt(7); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_men_err = (String)__sJT_st.getString(8); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ 
                      ...
                      if (v_cod_err == 0){
                        /*@lineinfo:generated-code*//*@lineinfo:329^25*/ /*//  *************************************************************//*//  #sql { COMMIT };*//*//  *************************************************************/ ((sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext().getOracleContext()).oracleCommit(sqlj.runtime.ref.DefaultContext.getDefaultContext()); /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:329^37*/
                      }
                      else{
                        /*@lineinfo:generated-code*//*@lineinfo:332^25*/ /*//  *************************************************************//*//  #sql { ROLLBACK };*//*//  *************************************************************/ ((sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext().getOracleContext()).oracleRollback(sqlj.runtime.ref.DefaultContext.getDefaultContext()); /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:332^39*/
                        /*@lineinfo:generated-code*//*@lineinfo:333^25*/ /*//  *************************************************************//*//  #sql { call TBPBD_INS_TBINTERFACE_LOGS( 'EG'*//*//                                 ,TO_DATE(:v_fecha_contrato,'RRRR-MM-DD')*//*//                                 , 'VU'*//*//                                 , :v_men_err*//*//                                 , :v_log_datos*//*//                                 , :v_producto*//*//                                 , null) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN TBPBD_INS_TBINTERFACE_LOGS( 'EG'\n                               ,TO_DATE( :1  ,'RRRR-MM-DD')\n                               , 'VU'\n                               ,  :2  \n                               ,  :3  \n                               ,  :4  \n                               , null)\n; END;"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"10TBPKT_UTILIDADES.TBPKT_VALOR_UNIDAD.SQL_CALCULO_VALOR_UNIDAD",theSqlTS); /*// set IN parameters*/ __sJT_st.setString(1,v_fecha_contrato); __sJT_st.setString(2,v_men_err); __sJT_st.setString(3,v_log_datos); __sJT_st.setString(4,v_producto); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ 
                        ...
                        /*@lineinfo:generated-code*//*@lineinfo:340^25*/ /*//  *************************************************************//*//  #sql { COMMIT };*//*//  *************************************************************/ ((sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext().getOracleContext()).oracleCommit(sqlj.runtime.ref.DefaultContext.getDefaultContext()); /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:340^37*/
                      }

                    }// fin si error de constraint
                    else{
                      if (v_cod_err == 0){
                        /*@lineinfo:generated-code*//*@lineinfo:346^25*/ /*//  *************************************************************//*//  #sql { COMMIT };*//*//  *************************************************************/ ((sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext().getOracleContext()).oracleCommit(sqlj.runtime.ref.DefaultContext.getDefaultContext()); /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:346^37*/
                      }
                      else{
                        /*@lineinfo:generated-code*//*@lineinfo:349^25*/ /*//  *************************************************************//*//  #sql { ROLLBACK };*//*//  *************************************************************/ ((sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext().getOracleContext()).oracleRollback(sqlj.runtime.ref.DefaultContext.getDefaultContext()); /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:349^39*/
                        /*@lineinfo:generated-code*//*@lineinfo:350^25*/ /*//  *************************************************************//*//  #sql { call TBPBD_INS_TBINTERFACE_LOGS( 'EG'*//*//                                                                  ,TO_DATE(:v_fecha_contrato,'RRRR-MM-DD')*//*//                                                                  , 'VU'*//*//                                                                  , :v_men_err*//*//                                                                  , :v_log_datos*//*//                                                                  , :v_producto*//*//                                                                  , null) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN TBPBD_INS_TBINTERFACE_LOGS( 'EG'\n                                                                ,TO_DATE( :1  ,'RRRR-MM-DD')\n                                                                , 'VU'\n                                                                ,  :2  \n                                                                ,  :3  \n                                                                ,  :4  \n                                                                , null)\n; END;"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"11TBPKT_UTILIDADES.TBPKT_VALOR_UNIDAD.SQL_CALCULO_VALOR_UNIDAD",theSqlTS); /*// set IN parameters*/ __sJT_st.setString(1,v_fecha_contrato); __sJT_st.setString(2,v_men_err); __sJT_st.setString(3,v_log_datos); __sJT_st.setString(4,v_producto); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ 
                        ...
                        /*@lineinfo:generated-code*//*@lineinfo:357^25*/ /*//  *************************************************************//*//  #sql { COMMIT };*//*//  *************************************************************/ ((sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext().getOracleContext()).oracleCommit(sqlj.runtime.ref.DefaultContext.getDefaultContext()); /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:357^37*/
                      }
                    }
                  }// fin si quiere actualizar
                }//Saldo de unidades es mayor a cero
      ...
      if (v_cod_err != 0){
        ...
        /*@lineinfo:generated-code*//*@lineinfo:402^9*/ /*//  *************************************************************//*//  #sql { call TBPBD_INS_TBINTERFACE_LOGS( 'EG'*//*//                                                  ,TO_DATE(:v_fecha_contrato,'RRRR-MM-DD')*//*//                                                  , 'VU'*//*//                                                  , :v_men_err*//*//                                                  , :v_log_datos*//*//                                                  , :v_producto*//*//                                                  , null) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN TBPBD_INS_TBINTERFACE_LOGS( 'EG'\n                                                ,TO_DATE( :1  ,'RRRR-MM-DD')\n                                                , 'VU'\n                                                ,  :2  \n                                                ,  :3  \n                                                ,  :4  \n                                                , null)\n; END;"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"12TBPKT_UTILIDADES.TBPKT_VALOR_UNIDAD.SQL_CALCULO_VALOR_UNIDAD",theSqlTS); /*// set IN parameters*/ __sJT_st.setString(1,v_fecha_contrato); __sJT_st.setString(2,v_men_err); __sJT_st.setString(3,v_log_datos); __sJT_st.setString(4,v_producto); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ 
        ...
        /*@lineinfo:generated-code*//*@lineinfo:409^9*/ /*//  *************************************************************//*//  #sql { COMMIT };*//*//  *************************************************************/ ((sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : sqlj.runtime.ref.DefaultContext.getDefaultContext().getExecutionContext().getOracleContext()).oracleCommit(sqlj.runtime.ref.DefaultContext.getDefaultContext()); /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:409^21*/
      }
    }catch(Exception e){
