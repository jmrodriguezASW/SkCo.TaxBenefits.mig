...
*presenta al usuario la información actual y da lo opcion de modificarlo.*/
//public class TBCL_Banco extends Object
public class TBCL_Banco extends HttpServlet
{
 /**Iterator código del banco y numero de cuenta del retiro a modificar.*/
 /*@lineinfo:generated-code*//*@lineinfo:29^2*/ /*//  *************************************************************//*//  SQLJ iterator declaration:*//*//  *************************************************************/ class i_banco extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_banco(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); RET_BANCONdx = findColumn("RET_BANCO"); RET_CUENTANdx = findColumn("RET_CUENTA"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public String RET_BANCO() throws java.sql.SQLException { return (String)m_rs.getString(RET_BANCONdx); } private int RET_BANCONdx; public String RET_CUENTA() throws java.sql.SQLException { return (String)m_rs.getString(RET_CUENTANdx); } private int RET_CUENTANdx; } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:29^61*/
 ...
 * y dar la opción de modificarlos segun las nuevas cuentas registradas en el AS400. */
 public void TBPL_ModificarBanco(PrintWriter out,HttpSession session,HttpServletRequest request,String nuevaCadena )
 {
  ...
  try
  {
   ...
   /**Tipo String*/
   String v_banco            = "";/**Variable código del banco*/
   String v_cuenta           = "";/**Variable número de cuenta*/
   ...
   String v_banconulo        = " ";/**Variable código del banco*/
   ...
   if((java.lang.String)session.getAttribute("s_contrato")!= null ||(java.lang.String)session.getAttribute("s_producto") != null)
   {
    ...
    /**Capturar variables de session*/
    /*@lineinfo:generated-code*//*@lineinfo:97^5*/ /*//  *************************************************************//*//  #sql v_bancocon = { SELECT RET_BANCO,RET_CUENTA*//*//                            FROM TBRETIROS*//*//                           WHERE RET_CON_PRO_CODIGO = :v_pro*//*//                             AND RET_CON_NUMERO     = :v_contra*//*//                             AND RET_CONSECUTIVO    = :v_consecutivo2*//*//                         };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "SELECT RET_BANCO,RET_CUENTA\n                          FROM TBRETIROS\n                         WHERE RET_CON_PRO_CODIGO =  :1  \n                           AND RET_CON_NUMERO     =  :2  \n                           AND RET_CONSECUTIVO    =  :3 "; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"0TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_Banco",theSqlTS); /*// set IN parameters*/ __sJT_st.setString(1,v_pro); __sJT_st.setString(2,v_contra); __sJT_st.setInt(3,v_consecutivo2); /*// execute query*/ v_bancocon = new TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_Banco.i_banco(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"0TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_Banco",null)); } finally { __sJT_ec.oracleCloseQuery(); } } /*//  *************************************************************/ 
    ...
    /**Si el dato de código del banco es null se asigna blanco*/
    try
    {
     if(v_banco == null)
     {
     ...
     */
     ...
     {//
      ...
      out.println("<br>");
      out.println("<pre>");
      out.println("<FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=2><b>Código del banco  "+v_banco+" y número de cuenta "+v_cuenta+" .<b></font>");
      out.println("<br>");
