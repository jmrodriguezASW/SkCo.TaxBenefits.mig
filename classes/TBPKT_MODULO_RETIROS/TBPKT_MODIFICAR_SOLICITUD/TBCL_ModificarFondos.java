...
public class TBCL_ModificarFondos extends HttpServlet
{
 ...
 /*@lineinfo:generated-code*//*@lineinfo:20^2*/ /*//  *************************************************************//*//  SQLJ iterator declaration:*//*//  *************************************************************/ public static class i_distri extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_distri(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); DIF_VALORNdx = findColumn("DIF_VALOR"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public double DIF_VALOR() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(DIF_VALORNdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int DIF_VALORNdx; } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:20^55*/
 /**Iterator de valor y porcentaje retirado de fondos de la solicitudes de retiro a modificar.*/
 /*@lineinfo:generated-code*//*@lineinfo:22^2*/ /*//  *************************************************************//*//  SQLJ iterator declaration:*//*//  *************************************************************/ public static class i_distri2 extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_distri2(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); DIF_VALORNdx = findColumn("DIF_VALOR"); DIF_PORCENTAJENdx = findColumn("DIF_PORCENTAJE"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public double DIF_VALOR() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(DIF_VALORNdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int DIF_VALORNdx; public double DIF_PORCENTAJE() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(DIF_PORCENTAJENdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int DIF_PORCENTAJENdx; } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:22^79*/
  ...
  try
  {
   ...
   if((java.lang.String)session.getAttribute("s_contrato") != null ||(java.lang.String)session.getAttribute("s_producto") != null)
   {
    ...
    for ( int i=1;i< new Integer(v_maximo).intValue();i++)
    {
     ...
     /*@lineinfo:generated-code*//*@lineinfo:135^6*/ /*//  *************************************************************//*//  #sql v_distri2 = { SELECT DIF_VALOR,DIF_PORCENTAJE*//*//                            FROM tbdistribucion_fondos*//*//                           WHERE DIF_RET_CON_PRO_CODIGO = :v_pro*//*//                             AND DIF_RET_CON_NUMERO= :v_contra*//*//                             AND DIF_RET_CONSECUTIVO = :v_conret*//*//                             AND dif_ref_fondo = :v_codigofondo*//*//                        ORDER BY dif_ref_fondo*//*//                         };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "SELECT DIF_VALOR,DIF_PORCENTAJE\n                          FROM tbdistribucion_fondos\n                         WHERE DIF_RET_CON_PRO_CODIGO =  :1  \n                           AND DIF_RET_CON_NUMERO=  :2  \n                           AND DIF_RET_CONSECUTIVO =  :3  \n                           AND dif_ref_fondo =  :4  \n                      ORDER BY dif_ref_fondo"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"1TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_ModificarFondos",theSqlTS); /*// set IN parameters*/ __sJT_st.setString(1,v_pro); __sJT_st.setString(2,v_contra); __sJT_st.setInt(3,v_conret); __sJT_st.setString(4,v_codigofondo); /*// execute query*/ v_distri2 = new TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_ModificarFondos.i_distri2(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"1TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_ModificarFondos",null)); } finally { __sJT_ec.oracleCloseQuery(); } } /*//  *************************************************************/ 
    ...
    if(v_fondo.equals("0"))
    {
     ...
     out.close();
    ...
    else if(v_fondo.equals("1"))/**Retiro distribución por valor*/
         {
          ...
          /*Cambio para manejo de referencia unica 2009/03/30 MOS */
          String v_contrato_unif = "";
         /*@lineinfo:generated-code*//*@lineinfo:268^10*/ /*//  *************************************************************//*//  #sql v_contrato_unif = { values(TBFBD_obtener_ref_unica(:v_pro,:v_contra)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TBFBD_obtener_ref_unica( :2  , :3  ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"3TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_ModificarFondos",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_pro); __sJT_st.setString(3,v_contra); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_contrato_unif = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:268^83*/
          out.println("<center><FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Producto</b> "+v_pro+"    <b>Contrato</b>"+v_contrato_unif+" </center></font>");
          out.println("<center><FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Nombres</b>  "+v_nom+"  <b> Apellidos </b>"+v_ape+" </CENTER></font>");
          out.println("<br>");
          out.println("<center><FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Valor a retirar</b>  "+NumberFormat.getCurrencyInstance().format(v_valre2)+" </cENTER></font>");
         ...
         /**Si no se encuentran datos*/
          ...
          out.close();
         ...
         else if(v_fondo.equals("2"))/**Retiro distribución por porcentaje*/
              {
               ...
               /*Cambio para manejo de referencia unica 2009/03/30 MOS */
               String v_contrato_unif = "";
              /*@lineinfo:generated-code*//*@lineinfo:323^15*/ /*//  *************************************************************//*//  #sql v_contrato_unif = { values(TBFBD_obtener_ref_unica(:v_pro,:v_contra)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TBFBD_obtener_ref_unica( :2  , :3  ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"4TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_ModificarFondos",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_pro); __sJT_st.setString(3,v_contra); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_contrato_unif = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:323^88*/
               out.println("<center><FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Producto</b> "+v_pro+"    <b>Contrato</b>"+v_contrato_unif+" </center></font>");
               out.println("<center><FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Nombres</b>  "+v_nom+"  <b> Apellidos </b>"+v_ape+" </CENTER></font>");
               out.println("<br>");
               out.println("<center><FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Valor a retirar</b>  "+NumberFormat.getCurrencyInstance().format(v_valre2)+" </cENTER></font>");
