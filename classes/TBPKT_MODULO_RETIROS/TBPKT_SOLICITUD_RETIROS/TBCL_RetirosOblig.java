...
public class TBCL_RetirosOblig extends HttpServlet{
    ...
    /*@lineinfo:generated-code*//*@lineinfo:19^5*/ /* //  ************************************************************ */ /* //  SQLJ iterator declaration: */ /* //  ************************************************************ */  public static class i_cumple extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_cumple(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); CON_NOMBRESNdx = findColumn("CON_NOMBRES"); CON_APELLIDOSNdx = findColumn("CON_APELLIDOS"); REF_VALORNdx = findColumn("REF_VALOR"); CON_NUMERO_IDENTIFICACIONNdx = findColumn("CON_NUMERO_IDENTIFICACION"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public String CON_NOMBRES() throws java.sql.SQLException { return (String)m_rs.getString(CON_NOMBRESNdx); } private int CON_NOMBRESNdx; public String CON_APELLIDOS() throws java.sql.SQLException { return (String)m_rs.getString(CON_APELLIDOSNdx); } private int CON_APELLIDOSNdx; public String REF_VALOR() throws java.sql.SQLException { return (String)m_rs.getString(REF_VALORNdx); } private int REF_VALORNdx; public String CON_NUMERO_IDENTIFICACION() throws java.sql.SQLException { return (String)m_rs.getString(CON_NUMERO_IDENTIFICACIONNdx); } private int CON_NUMERO_IDENTIFICACIONNdx; } /* //  ************************************************************ */  


                                                                          /*@lineinfo:user-code*//*@lineinfo:22^74*/

    /**Iterator de la información del tipo de usuarion.*/
    /*@lineinfo:generated-code*//*@lineinfo:25^5*/ /* //  ************************************************************ */ /* //  SQLJ iterator declaration: */ /* //  ************************************************************ */  public static class i_tipo extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_tipo(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); COT_DESCRIPCIONNdx = findColumn("COT_DESCRIPCION"); COT_REF_TIPO_TRANSACCIONNdx = findColumn("COT_REF_TIPO_TRANSACCION"); COT_REF_CLASE_TRANSACCIONNdx = findColumn("COT_REF_CLASE_TRANSACCION"); PRC_RETIRO_TOTALNdx = findColumn("PRC_RETIRO_TOTAL"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public String COT_DESCRIPCION() throws java.sql.SQLException { return (String)m_rs.getString(COT_DESCRIPCIONNdx); } private int COT_DESCRIPCIONNdx; public String COT_REF_TIPO_TRANSACCION() throws java.sql.SQLException { return (String)m_rs.getString(COT_REF_TIPO_TRANSACCIONNdx); } private int COT_REF_TIPO_TRANSACCIONNdx; public String COT_REF_CLASE_TRANSACCION() throws java.sql.SQLException { return (String)m_rs.getString(COT_REF_CLASE_TRANSACCIONNdx); } private int COT_REF_CLASE_TRANSACCIONNdx; public String PRC_RETIRO_TOTAL() throws java.sql.SQLException { return (String)m_rs.getString(PRC_RETIRO_TOTALNdx); } private int PRC_RETIRO_TOTALNdx; } /* //  ************************************************************ */  
    ...
    public void TBPL_FechaRetiro(PrintWriter out,HttpSession session,HttpServletRequest request,String nuevaCadena)
    {
        ...
        try
        {
          ...
          /*@lineinfo:generated-code*//*@lineinfo:77^11*/ /* //  ************************************************************ */ /* //  #sql { select ref_descripcion  from tbreferencias WHERE REF_CODIGO='DSR001' }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); oracle.jdbc.OracleResultSet __sJT_rs = null; try { String theSqlTS = "select ref_descripcion   from tbreferencias WHERE REF_CODIGO='DSR001'"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"0TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosOblig",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.setFetchSize(2); } /* // execute query */  __sJT_rs = __sJT_ec.oracleExecuteQuery(); if (__sJT_rs.getMetaData().getColumnCount() != 1) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(1,__sJT_rs.getMetaData().getColumnCount()); if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO(); /* // retrieve OUT parameters */  s_ruta_serv = (String)__sJT_rs.getString(1); if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO(); } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); } } /* //  ************************************************************ */  /*@lineinfo:user-code*//*@lineinfo:77^102*/  
          session.removeValue("s_ruta_serv");
          session.putValue("s_ruta_serv",(java.lang.Object)s_ruta_serv);  
            
          /**Consultar datos del contrato*/
          /*@lineinfo:generated-code*//*@lineinfo:82^11*/ /* //  ************************************************************ */ /* //  #sql v_cum = { select   CON_NOMBRES */ /* //                                  ,CON_APELLIDOS */ /* //                                  ,REF_VALOR */ /* //                                  ,CON_NUMERO_IDENTIFICACION */ /* //                         from     tbcontratos_oblig */ /* //                                  inner join TBREFERENCIAS on ref_codigo = CON_REF_TIPO_IDENTIFICACION */ /* //                         where    CON_PRO_CODIGO =:v_pro */ /* //                                  and LPAD(CON_NUMERO,9, '0')=:v_contra */ /* //                          }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "select   CON_NOMBRES\n                                ,CON_APELLIDOS\n                                ,REF_VALOR\n                                ,CON_NUMERO_IDENTIFICACION \n                       from     tbcontratos_oblig    \n                                inner join TBREFERENCIAS on ref_codigo = CON_REF_TIPO_IDENTIFICACION\n                       where    CON_PRO_CODIGO = :1   \n                                and LPAD(CON_NUMERO,9, '0')= :2 "; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"1TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosOblig",theSqlTS); /* // set IN parameters */  __sJT_st.setString(1,v_pro); __sJT_st.setString(2,v_contra); /* // execute query */  v_cum = new TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosOblig.i_cumple(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"1TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosOblig",null)); } finally { __sJT_ec.oracleCloseQuery(); } } /* //  ************************************************************ */  
          ...
          while (v_cum.next())
          {
           ...
           out.println("<br>");                             
           /*@lineinfo:generated-code*//*@lineinfo:116^12*/ /* //  ************************************************************ */ /* //  #sql { select TO_CHAR(to_date(sysdate, 'DD/MM/RR'), 'yyyy-mm-dd') fecha_actual  from dual }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); oracle.jdbc.OracleResultSet __sJT_rs = null; try { String theSqlTS = "select TO_CHAR(to_date(sysdate, 'DD/MM/RR'), 'yyyy-mm-dd') fecha_actual   from dual"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"3TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosOblig",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.setFetchSize(2); } /* // execute query */  __sJT_rs = __sJT_ec.oracleExecuteQuery(); if (__sJT_rs.getMetaData().getColumnCount() != 1) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(1,__sJT_rs.getMetaData().getColumnCount()); if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO(); /* // retrieve OUT parameters */  v_fechaActual = (String)__sJT_rs.getString(1); if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO(); } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); } } /* //  ************************************************************ */  /*@lineinfo:user-code*//*@lineinfo:116^119*/           
           out.println("<input type='hidden' name='txtfechaActual' value='"+v_fechaActual+"'>");            
           
           /*@lineinfo:generated-code*//*@lineinfo:119^12*/ /* //  ************************************************************ */ /* //  #sql { call TBPBD_APLICA_RET_TOTAL_OBLIG( :v_pro */ /* //                                              ,:v_contra */ /* //                                              ,:bloqueoRetiroTotal */ /* //                                              ,:v_coderr */ /* //                                              ,:v_msgErr) }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN TBPBD_APLICA_RET_TOTAL_OBLIG(  :1  \n                                            , :2  \n                                            , :3  \n                                            , :4  \n                                            , :5  )\n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"4TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosOblig",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(3,oracle.jdbc.OracleTypes.VARCHAR); __sJT_st.registerOutParameter(4,oracle.jdbc.OracleTypes.VARCHAR); __sJT_st.registerOutParameter(5,oracle.jdbc.OracleTypes.VARCHAR); } /* // set IN parameters */  __sJT_st.setString(1,v_pro); __sJT_st.setString(2,v_contra); __sJT_st.setString(3,bloqueoRetiroTotal); __sJT_st.setString(4,v_coderr); __sJT_st.setString(5,v_msgErr); /* // execute statement */  __sJT_ec.oracleExecuteUpdate(); /* // retrieve OUT parameters */  bloqueoRetiroTotal = (String)__sJT_st.getString(3); v_coderr = (String)__sJT_st.getString(4); v_msgErr = (String)__sJT_st.getString(5); } finally { __sJT_ec.oracleClose(); } } /* //  ************************************************************ */  
           ...
           /*@lineinfo:generated-code*//*@lineinfo:127^12*/ /* //  ************************************************************ */ /* //  #sql v_tipo = { SELECT COT_DESCRIPCION */ /* //                                  ,COT_REF_TIPO_TRANSACCION */ /* //                                  ,COT_REF_CLASE_TRANSACCION */ /* //                                  ,PRC_RETIRO_TOTAL */ /* //                          FROM    TBPRODUCTOS_CONCEPTOS */ /* //                          INNER JOIN TBCONCEPTOS_TRANSACCION ON PRC_COT_REF_TRANSACCION           = COT_REF_TRANSACCION */ /* //                                                                AND PRC_COT_REF_TIPO_TRANSACCION  = COT_REF_TIPO_TRANSACCION */ /* //                                                                AND PRC_COT_REF_CLASE_TRANSACCION = COT_REF_CLASE_TRANSACCION */ /* //                          WHERE   PRC_PRO_CODIGO                = :v_pro */ /* //                                  AND PRC_COT_REF_TRANSACCION   = 'STR001' */ /* //                                  AND PRC_ORIGEN_TAXB           = 'S' */ /* //                          ORDER BY COT_DESCRIPCION }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "SELECT COT_DESCRIPCION\n                                ,COT_REF_TIPO_TRANSACCION\n                                ,COT_REF_CLASE_TRANSACCION                                                                \n                                ,PRC_RETIRO_TOTAL                               \n                        FROM    TBPRODUCTOS_CONCEPTOS\n                        INNER JOIN TBCONCEPTOS_TRANSACCION ON PRC_COT_REF_TRANSACCION           = COT_REF_TRANSACCION\n                                                              AND PRC_COT_REF_TIPO_TRANSACCION  = COT_REF_TIPO_TRANSACCION\n                                                              AND PRC_COT_REF_CLASE_TRANSACCION = COT_REF_CLASE_TRANSACCION \n                        WHERE   PRC_PRO_CODIGO                =  :1   \n                                AND PRC_COT_REF_TRANSACCION   = 'STR001'                                \n                                AND PRC_ORIGEN_TAXB           = 'S'\n                        ORDER BY COT_DESCRIPCION"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"5TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosOblig",theSqlTS); /* // set IN parameters */  __sJT_st.setString(1,v_pro); /* // execute query */  v_tipo = new TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosOblig.i_tipo(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"5TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosOblig",null)); } finally { __sJT_ec.oracleCloseQuery(); } } /* //  ************************************************************ */  
