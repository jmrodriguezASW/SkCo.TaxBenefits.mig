...
public class TBCL_SeleccionAportes extends HttpServlet {
    ...
    /**Iterator de aportes*/
     /*@lineinfo:generated-code*//*@lineinfo:20^6*/ /*//  *************************************************************//*//  SQLJ iterator declaration:*//*//  *************************************************************/ public static class i_aportes extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_aportes(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); APO_CONSECUTIVONdx = findColumn("APO_CONSECUTIVO"); APO_FECHA_EFECTIVANdx = findColumn("APO_FECHA_EFECTIVA"); SALDO_CAPITALNdx = findColumn("SALDO_CAPITAL"); SALDO_RENDIMIENTOSNdx = findColumn("SALDO_RENDIMIENTOS"); SALDO_CUENTA_CONTINGENTENdx = findColumn("SALDO_CUENTA_CONTINGENTE"); SALDO_RETENCION_RENDNdx = findColumn("SALDO_RETENCION_REND"); SALDO_UNIDADESNdx = findColumn("SALDO_UNIDADES"); APO_APORTE_TRASLADONdx = findColumn("APO_APORTE_TRASLADO"); APO_INFORMACION_TRASLADONdx = findColumn("APO_INFORMACION_TRASLADO"); APO_APORTE_EMPRESANdx = findColumn("APO_APORTE_EMPRESA"); POR_CCNdx = findColumn("POR_CC"); POR_RET_RENDNdx = findColumn("POR_RET_REND"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public double APO_CONSECUTIVO() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(APO_CONSECUTIVONdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int APO_CONSECUTIVONdx; public java.sql.Date APO_FECHA_EFECTIVA() throws java.sql.SQLException { return (java.sql.Date)m_rs.getDate(APO_FECHA_EFECTIVANdx); } private int APO_FECHA_EFECTIVANdx; public double SALDO_CAPITAL() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(SALDO_CAPITALNdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int SALDO_CAPITALNdx; public double SALDO_RENDIMIENTOS() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(SALDO_RENDIMIENTOSNdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int SALDO_RENDIMIENTOSNdx; public double SALDO_CUENTA_CONTINGENTE() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(SALDO_CUENTA_CONTINGENTENdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int SALDO_CUENTA_CONTINGENTENdx; public double SALDO_RETENCION_REND() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(SALDO_RETENCION_RENDNdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int SALDO_RETENCION_RENDNdx; public double SALDO_UNIDADES() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(SALDO_UNIDADESNdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int SALDO_UNIDADESNdx; public String APO_APORTE_TRASLADO() throws java.sql.SQLException { return (String)m_rs.getString(APO_APORTE_TRASLADONdx); } private int APO_APORTE_TRASLADONdx; public String APO_INFORMACION_TRASLADO() throws java.sql.SQLException { return (String)m_rs.getString(APO_INFORMACION_TRASLADONdx); } private int APO_INFORMACION_TRASLADONdx; public String APO_APORTE_EMPRESA() throws java.sql.SQLException { return (String)m_rs.getString(APO_APORTE_EMPRESANdx); } private int APO_APORTE_EMPRESANdx; public double POR_CC() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(POR_CCNdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int POR_CCNdx; public double POR_RET_REND() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(POR_RET_RENDNdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int POR_RET_RENDNdx; } /*//  *************************************************************/ 
