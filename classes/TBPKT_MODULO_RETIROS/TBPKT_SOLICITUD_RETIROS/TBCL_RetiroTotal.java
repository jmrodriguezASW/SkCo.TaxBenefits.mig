...
//         if(v_cumes2<v_diasmenor2)
     ...
     if(v_pasa == 0  && v_pasa2 == 0)
     {
      ...
      if(v_traslado.equals("S"))
      {
       ...
       if(v_traslado.equals("S") && v_intext.equals("STA001"))
       {
        ...
        if(v_tipoconti.equals("E"))
        {
         ...
         {
          /*@lineinfo:generated-code*//*@lineinfo:301^11*/ /*//  *************************************************************//*//  #sql v_resp = { SELECT CON_NUMERO*//*//                                    ,CON_REF_TIPO_IDENTIFICACION*//*//                                    ,CON_NUMERO_IDENTIFICACION*//*//                                FROM tbcontratos*//*//                               WHERE con_pro_codigo = :v_proti*//*//                                 AND con_numero = :v_conti2*//*//                              };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "SELECT CON_NUMERO\n                                  ,CON_REF_TIPO_IDENTIFICACION\n                                  ,CON_NUMERO_IDENTIFICACION\n                              FROM tbcontratos\n                             WHERE con_pro_codigo =  :1  \n                               AND con_numero =  :2 "; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"0TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroTotal",theSqlTS); /*// set IN parameters*/ __sJT_st.setString(1,v_proti); __sJT_st.setString(2,v_conti2); /*// execute query*/ v_resp = new TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroTotal.i_res(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"0TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroTotal",null)); } finally { __sJT_ec.oracleCloseQuery(); } } /*//  *************************************************************/ 
      ...
      {//1
       ...
       /*@lineinfo:generated-code*//*@lineinfo:551^8*/ /*//  *************************************************************//*//  #sql v_aportes = { values (TB_FSELECCION_RETTOTAL( :v_pro*//*//                                                           ,:v_contra*//*//                                                           ,to_number(:v_canje)*//*//                                                           ,:v_fecefe*//*//                                                           ,:v_fecpro*//*//                                                           ,:v_certifi*//*//                                                           ,:v_canje2*//*//                                                           ,:v_disponi*//*//                                                           ,:v_fecmay*//*//                                                           ,:v_indtras*//*//                                                          )) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TB_FSELECCION_RETTOTAL(  :2  \n                                                         , :3  \n                                                         ,to_number( :4  )\n                                                         , :5  \n                                                         , :6  \n                                                         , :7  \n                                                         , :8  \n                                                         , :9  \n                                                         , :10  \n                                                         , :11  \n                                                        ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"3TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroTotal",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(7,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(8,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(9,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(10,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(11,oracle.jdbc.OracleTypes.INTEGER); } /*// set IN parameters*/ __sJT_st.setString(2,v_pro); __sJT_st.setString(3,v_contra); __sJT_st.setString(4,v_canje); __sJT_st.setString(5,v_fecefe); __sJT_st.setString(6,v_fecpro); __sJT_st.setInt(7,v_certifi); __sJT_st.setInt(8,v_canje2); __sJT_st.setInt(9,v_disponi); __sJT_st.setInt(10,v_fecmay); __sJT_st.setInt(11,v_indtras); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_aportes = __sJT_st.getInt(1); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_certifi = __sJT_st.getInt(7); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_canje2 = __sJT_st.getInt(8); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_disponi = __sJT_st.getInt(9); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_fecmay = __sJT_st.getInt(10); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_indtras = __sJT_st.getInt(11); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ 
       ...
       if(v_aportes == 0)
       {//1
          /*@lineinfo:generated-code*//*@lineinfo:567^11*/ /*//  *************************************************************//*//  #sql { SELECT  COUNT(1)*//*//*//*//                     FROM  TBRETIROS*//*//                     WHERE RET_CON_PRO_CODIGO = :v_pro*//*//                       AND RET_CON_NUMERO     = :v_contra*//*//                       AND RET_FECHA_EFECTIVA > TO_DATE(:v_fecefe,'RRRR-MM-DD')*//*//                       AND (RET_REF_ESTADO      = 'SER001' OR RET_REF_ESTADO      = 'SER006')*//*//                  };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); oracle.jdbc.OracleResultSet __sJT_rs = null; try { String theSqlTS = "SELECT  COUNT(1)\n                    \n                   FROM  TBRETIROS\n                   WHERE RET_CON_PRO_CODIGO =  :1  \n                     AND RET_CON_NUMERO     =  :2  \n                     AND RET_FECHA_EFECTIVA > TO_DATE( :3  ,'RRRR-MM-DD')\n                     AND (RET_REF_ESTADO      = 'SER001' OR RET_REF_ESTADO      = 'SER006')"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"4TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroTotal",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.setFetchSize(2); } /*// set IN parameters*/ __sJT_st.setString(1,v_pro); __sJT_st.setString(2,v_contra); __sJT_st.setString(3,v_fecefe); /*// execute query*/ __sJT_rs = __sJT_ec.oracleExecuteQuery(); if (__sJT_rs.getMetaData().getColumnCount() != 1) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(1,__sJT_rs.getMetaData().getColumnCount()); if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO(); /*// retrieve OUT parameters*/ v_retirovigente = __sJT_rs.getInt(1); if (__sJT_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO(); } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); } } /*//  *************************************************************/ 
      ...
      {/**Si no es correcta la validación del contrato traslado*/
       ...
       /*Cambio para manejo de referencia unica 2009/03/30 MOS */
       String v_contrato_unif = "";
       /*@lineinfo:generated-code*//*@lineinfo:656^8*/ /*//  *************************************************************//*//  #sql v_contrato_unif = { values(TBFBD_obtener_ref_unica(:v_pro,:v_contra)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TBFBD_obtener_ref_unica( :2  , :3  ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"5TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroTotal",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_pro); __sJT_st.setString(3,v_contra); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_contrato_unif = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:656^81*/
       out.println("<FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Producto</b> "+v_pro+"    <b>Contrato</b>"+v_contrato_unif+" </center></font>");
       out.println("<FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Nombres</b>  "+v_nom+"  <b> Apellidos </b>"+v_ape+" </CENTER></font>");
       out.println("<br>");
     ...
     {/**Si no se cumple con la parametrización de los dias permitidos para el concepto de retiro*/
      ...
      /*Cambio para manejo de referencia unica 2009/03/30 MOS */
      String v_contrato_unif = "";
      /*@lineinfo:generated-code*//*@lineinfo:704^7*/ /*//  *************************************************************//*//  #sql v_contrato_unif = { values(TBFBD_obtener_ref_unica(:v_pro,:v_contra)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TBFBD_obtener_ref_unica( :2  , :3  ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"6TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroTotal",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_pro); __sJT_st.setString(3,v_contra); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_contrato_unif = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:704^80*/
      out.println("<FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Producto</b> "+v_pro+"    <b>Contrato</b>"+v_contrato_unif+" </center></font>");
      out.println("<FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Nombres</b>  "+v_nom+"  <b> Apellidos </b>"+v_ape+" </CENTER></font>");
      out.println("<br>");
   ...
   {/**Terminar session*/
    v_pintar=    i_pagina.TBFL_CABEZA("Solicitud de Retiro","Error Retiro Total","","<center>Error de comunicación no se tiene conexión con el servidor web,por favor intente de nuevo.</center>",false);
    out.println(""+v_pintar+"");
    v_pie = i_pagina.TBFL_PIE;
    out.println("<br>");
  ...
  catch(Exception ex)
  {
   ...
   {
    v_pintar=    i_pagina.TBFL_CABEZA("Solicitud de Retiro","Error Retiro Total","","<center>No se tiene comunicación con el servidor de datos  por favor ingrese nuevamente.</center>",false);
   }
   else if (error.trim().equals("java.sql.SQLException: Io exception: Connection reset by peer: socket write error"))
        {
         v_pintar=    i_pagina.TBFL_CABEZA("Solicitud de Retiro","Error Retiro Total","","<center>Se reinicio la base de datos por favor ingrese nuevamente.</center>",false);
                ...
                {
                 v_pintar = i_pagina.TBFL_CABEZA("Solicitud de Retiro","Error Retiro Total","","<center>Error momentaneo de comunicación con el servidor de datos, por favor intente entrar de nuevo a la opción.</center>",false);
                }
                else if(error.trim().equalsIgnoreCase("java.sql.SQLException:IOEXCEPTION:DESCRIPTOR NOT A SOCKET:SOCKET WRITE ERROR"))
                     {
                       v_pintar = i_pagina.TBFL_CABEZA("Solicitud de Retiro","Error Retiro Total","","<center>Error momentaneo de comunicación con el servidor Web, por favor intente entrar de nuevo a la opción.</center>",false);
                     }
                  else
                  {
