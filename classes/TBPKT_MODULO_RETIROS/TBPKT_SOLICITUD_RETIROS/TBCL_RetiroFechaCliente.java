...
public class TBCL_RetiroFechaCliente extends HttpServlet
{
 ...
 /*@lineinfo:generated-code*//*@lineinfo:37^2*/ /*//  *************************************************************//*//  SQLJ iterator declaration:*//*//  *************************************************************/ public static class i_tipo2 extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_tipo2(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); COT_DESCRIPCIONNdx = findColumn("COT_DESCRIPCION"); COT_REF_TIPO_TRANSACCIONNdx = findColumn("COT_REF_TIPO_TRANSACCION"); COT_REF_CLASE_TRANSACCIONNdx = findColumn("COT_REF_CLASE_TRANSACCION"); PRC_RETIRO_PENALIZADONdx = findColumn("PRC_RETIRO_PENALIZADO"); PRC_TRASLADONdx = findColumn("PRC_TRASLADO"); PRC_RETIRO_TOTALNdx = findColumn("PRC_RETIRO_TOTAL"); v_diasmenorNdx = findColumn("v_diasmenor"); v_diasmayorNdx = findColumn("v_diasmayor"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public String COT_DESCRIPCION() throws java.sql.SQLException { return (String)m_rs.getString(COT_DESCRIPCIONNdx); } private int COT_DESCRIPCIONNdx; public String COT_REF_TIPO_TRANSACCION() throws java.sql.SQLException { return (String)m_rs.getString(COT_REF_TIPO_TRANSACCIONNdx); } private int COT_REF_TIPO_TRANSACCIONNdx; public String COT_REF_CLASE_TRANSACCION() throws java.sql.SQLException { return (String)m_rs.getString(COT_REF_CLASE_TRANSACCIONNdx); } private int COT_REF_CLASE_TRANSACCIONNdx; public String PRC_RETIRO_PENALIZADO() throws java.sql.SQLException { return (String)m_rs.getString(PRC_RETIRO_PENALIZADONdx); } private int PRC_RETIRO_PENALIZADONdx; public String PRC_TRASLADO() throws java.sql.SQLException { return (String)m_rs.getString(PRC_TRASLADONdx); } private int PRC_TRASLADONdx; public String PRC_RETIRO_TOTAL() throws java.sql.SQLException { return (String)m_rs.getString(PRC_RETIRO_TOTALNdx); } private int PRC_RETIRO_TOTALNdx; public String v_diasmenor() throws java.sql.SQLException { return (String)m_rs.getString(v_diasmenorNdx); } private int v_diasmenorNdx; public String v_diasmayor() throws java.sql.SQLException { return (String)m_rs.getString(v_diasmayorNdx); } private int v_diasmayorNdx; } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:37^239*/
 ...
 public void TBPL_FechaCliente(PrintWriter out,HttpSession session,HttpServletRequest request,String nuevaCadena,String v_contrato,String v_producto,String v_unidad ,String v_tipousu)
 {
  ...
  //String v_tuni      = (java.lang.String)session.getAttribute("s_unidad");/**Variable código unidad As400*/
   ...
   /*@lineinfo:generated-code*//*@lineinfo:102^4*/ /*//  *************************************************************//*//  #sql v_codusu = { values(TBFBD_REFERENCIAS(:v_tipousu,'UTU')) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TBFBD_REFERENCIAS( :2  ,'UTU') \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"0TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroFechaCliente",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_tipousu); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_codusu = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:102^63*/
   /*@lineinfo:generated-code*//*@lineinfo:103^4*/ /*//  *************************************************************//*//  #sql v_coduni = { values(TBFBD_REFERENCIAS(:v_unidad,'UUP')) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TBFBD_REFERENCIAS( :2  ,'UUP') \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"1TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroFechaCliente",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_unidad); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_coduni = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:103^62*/
   ...
   {//if usuario
    ...
    if(!v_coduni.equals("XXXXXX"))
    {
     ...
     /*@lineinfo:generated-code*//*@lineinfo:116^6*/ /*//  *************************************************************//*//  #sql v_tipoci = { values(TB_FTIPO_CIERRE(:v_coduni)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TB_FTIPO_CIERRE( :2  ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"2TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroFechaCliente",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_coduni); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_tipoci = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:116^57*/
     if(v_tipoci.equals("T"))
     {
      /**Es cierre total entonces la fecha efectiva del retiro es proxima fecha habil*/
      /*@lineinfo:generated-code*//*@lineinfo:120^7*/ /*//  *************************************************************//*//  #sql v_fecha = { values(TB_FFECHA_SIGUIENTE(1)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TB_FFECHA_SIGUIENTE(1) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"3TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroFechaCliente",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.DATE); } /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_fecha = (java.sql.Date)__sJT_st.getDate(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:120^53*/
      v_validafecha = true;
     }
     else
     {
      ...
      * se averigua que hora de cierre hay para la unidad y tipo de usuario*/
      ...
      if(!v_horacie.equals("ERROR"))
      {
       if( new Integer(v_hora).intValue() > new Integer(v_horacie).intValue())
       {
        ...
        /*@lineinfo:generated-code*//*@lineinfo:134^9*/ /*//  *************************************************************//*//  #sql v_fecha = { values(TB_FFECHA_SIGUIENTE(1)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TB_FFECHA_SIGUIENTE(1) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"6TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroFechaCliente",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.DATE); } /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_fecha = (java.sql.Date)__sJT_st.getDate(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:134^55*/
        v_validafecha = true;
       }
       else
       {
        /**Queda el dia habil*/
        /*@lineinfo:generated-code*//*@lineinfo:140^9*/ /*//  *************************************************************//*//  #sql v_fecha = { values(TB_FFECHA_SIGUIENTE(0)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TB_FFECHA_SIGUIENTE(0) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"7TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroFechaCliente",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.DATE); } /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_fecha = (java.sql.Date)__sJT_st.getDate(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:140^55*/
        v_validafecha = true;
       }
      }
      else
      ...
      {//1
        ...
        */
        ...
        {//3
         ...
         /*@lineinfo:generated-code*//*@lineinfo:269^10*/ /*//  *************************************************************//*//  #sql v_tipo = { SELECT COT_DESCRIPCION*//*//                               ,COT_REF_TIPO_TRANSACCION*//*//                               ,COT_REF_CLASE_TRANSACCION*//*//                               ,PRC_RETIRO_PENALIZADO*//*//                               ,PRC_TRASLADO*//*//                               ,PRC_RETIRO_TOTAL*//*//                               ,TO_CHAR(PRC_DIAS_MENOR) v_diasmenor*//*//                               ,TO_CHAR(PRC_DIAS_MAYOR) v_diasmayor*//*//                           FROM TBPRODUCTOS_CONCEPTOS,TBCONCEPTOS_TRANSACCION*//*//                          WHERE PRC_PRO_CODIGO                = :v_producto*//*//                            AND PRC_COT_REF_TRANSACCION       = 'STR001'*//*//                            AND PRC_COT_REF_TRANSACCION       = COT_REF_TRANSACCION*//*//                            AND PRC_COT_REF_TIPO_TRANSACCION  = COT_REF_TIPO_TRANSACCION*//*//                            AND PRC_COT_REF_CLASE_TRANSACCION = COT_REF_CLASE_TRANSACCION*//*//                            AND TBPRODUCTOS_CONCEPTOS.PRC_ORIGEN_TAXB ='S'*//*//                            AND TBPRODUCTOS_CONCEPTOS.PRC_TRASLADO    = 'N'*//*//                       ORDER BY COT_DESCRIPCION };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "SELECT COT_DESCRIPCION\n                             ,COT_REF_TIPO_TRANSACCION\n                             ,COT_REF_CLASE_TRANSACCION\n                             ,PRC_RETIRO_PENALIZADO\n                             ,PRC_TRASLADO\n                             ,PRC_RETIRO_TOTAL\n                             ,TO_CHAR(PRC_DIAS_MENOR) v_diasmenor\n                             ,TO_CHAR(PRC_DIAS_MAYOR) v_diasmayor\n                         FROM TBPRODUCTOS_CONCEPTOS,TBCONCEPTOS_TRANSACCION\n                        WHERE PRC_PRO_CODIGO                =  :1  \n                          AND PRC_COT_REF_TRANSACCION       = 'STR001'\n                          AND PRC_COT_REF_TRANSACCION       = COT_REF_TRANSACCION\n                          AND PRC_COT_REF_TIPO_TRANSACCION  = COT_REF_TIPO_TRANSACCION\n                          AND PRC_COT_REF_CLASE_TRANSACCION = COT_REF_CLASE_TRANSACCION\n                          AND TBPRODUCTOS_CONCEPTOS.PRC_ORIGEN_TAXB ='S'\n                          AND TBPRODUCTOS_CONCEPTOS.PRC_TRASLADO    = 'N'\n                     ORDER BY COT_DESCRIPCION"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"11TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroFechaCliente",theSqlTS); /*// set IN parameters*/ __sJT_st.setString(1,v_producto); /*// execute query*/ v_tipo = new TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroFechaCliente.i_tipo2(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"11TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroFechaCliente",null)); } finally { __sJT_ec.oracleCloseQuery(); } } /*//  *************************************************************/ 
