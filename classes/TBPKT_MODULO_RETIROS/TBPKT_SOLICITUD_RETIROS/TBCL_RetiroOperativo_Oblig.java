...
public class TBCL_RetiroOperativo_Oblig extends HttpServlet{
    ...
    public void TBPL_SolicitudOperativo_Oblig(PrintWriter out,HttpSession session,HttpServletRequest request,String nuevaCadena) {
        ...
        {        
           ...
           /*@lineinfo:generated-code*//*@lineinfo:72^12*/ /* //  ************************************************************ */ /* //  #sql { SELECT TBF_OBTENER_FECHAS_X_TRANX(:v_pro, :v_tipotran, :v_clasetran, :v_fecefe) FECHA_EFECTIVA */ /* // */ /* //                     FROM DUAL }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); oracle.jdbc.OracleResultSet __sJT_rs = null; try { String theSqlTS = "SELECT TBF_OBTENER_FECHAS_X_TRANX( :1  ,  :2  ,  :3  ,  :4  ) FECHA_EFECTIVA\n                                                                                                         \n                   FROM DUAL"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"0TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroOperativo_Oblig",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.setFetchSize(2); } /* // set IN parameters */  __sJT_st.setString(1,v_pro); __sJT_st.setString(2,v_tipotran); __sJT_st.setString(3,v_clasetran); __sJT_st.setString(4,v_fecefe); /* // execute query */  __sJT_rs = __sJT_ec.oracleExecuteQuery(); if (__sJT_rs.getMetaData().getColumnCount() != 1) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(1,__sJT_rs.getMetaData().getColumnCount()); if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO(); /* // retrieve OUT parameters */  v_fecpro = (String)__sJT_rs.getString(1); if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO(); } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); } } /* //  ************************************************************ */  

                             /*@lineinfo:user-code*//*@lineinfo:74^29*/
                   
           session.removeValue("v_tipotran");
           session.putValue("v_tipotran", v_tipotran);                    
           ...
           session.removeValue("s_tiporetiro");
            session.putValue("s_tiporetiro", v_tiporetiro);            
            ...
            session.removeValue("v_clasetran");
            session.putValue("v_clasetran", v_clasetran);
        ...
        int    v_sw  = 1;
        /*@lineinfo:generated-code*//*@lineinfo:127^9*/ /* //  ************************************************************ */ /* //  #sql { SELECT ref_valor, con_numero_identificacion,  to_char(to_date(:v_fecefe,'YYYY/MM/DD'),'YYYYMMDD') */ /* // */ /* //                    FROM tbcontratos_oblig */ /* //                    INNER JOIN TBREFERENCIAS on CON_REF_TIPO_IDENTIFICACION = REF_CODIGO */ /* //                    WHERE con_pro_codigo = :v_pro */ /* //                    AND lpad(con_numero, 9, '0') = :v_contra }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); oracle.jdbc.OracleResultSet __sJT_rs = null; try { String theSqlTS = "SELECT ref_valor, con_numero_identificacion,  to_char(to_date( :1  ,'YYYY/MM/DD'),'YYYYMMDD') \n                     \n                  FROM tbcontratos_oblig\n                  INNER JOIN TBREFERENCIAS on CON_REF_TIPO_IDENTIFICACION = REF_CODIGO \n                  WHERE con_pro_codigo =  :2  \n                  AND lpad(con_numero, 9, '0') =  :3 "; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"1TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroOperativo_Oblig",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.setFetchSize(2); } /* // set IN parameters */  __sJT_st.setString(1,v_fecefe); __sJT_st.setString(2,v_pro); __sJT_st.setString(3,v_contra); /* // execute query */  __sJT_rs = __sJT_ec.oracleExecuteQuery(); if (__sJT_rs.getMetaData().getColumnCount() != 3) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(3,__sJT_rs.getMetaData().getColumnCount()); if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO(); /* // retrieve OUT parameters */  vtipoid = (String)__sJT_rs.getString(1); vnumid = (String)__sJT_rs.getString(2); vfecha_act = (String)__sJT_rs.getString(3); if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO(); } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); } } /* //  ************************************************************ */  
        ...
        /*@lineinfo:generated-code*//*@lineinfo:134^9*/ /* //  ************************************************************ */ /* //  #sql v_sw = { values(TB_FREFERENCIAS_FPOB(:v_pro, */ /* //                                                    :v_sistema_oblig, */ /* //                                                    :v_usuario_oblig, */ /* //                                                    :v_password_oblig, */ /* //                                                    :v_libreria_oblig, */ /* //                                                    :v_libd)) }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TB_FREFERENCIAS_FPOB( :2  ,\n                                                   :3  ,\n                                                   :4  ,\n                                                   :5  ,\n                                                   :6  ,\n                                                   :7  ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"2TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroOperativo_Oblig",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.INTEGER); __sJT_st.registerOutParameter(3,oracle.jdbc.OracleTypes.VARCHAR); __sJT_st.registerOutParameter(4,oracle.jdbc.OracleTypes.VARCHAR); __sJT_st.registerOutParameter(5,oracle.jdbc.OracleTypes.VARCHAR); __sJT_st.registerOutParameter(6,oracle.jdbc.OracleTypes.VARCHAR); __sJT_st.registerOutParameter(7,oracle.jdbc.OracleTypes.VARCHAR); } /* // set IN parameters */  __sJT_st.setString(2,v_pro); __sJT_st.setString(3,v_sistema_oblig); __sJT_st.setString(4,v_usuario_oblig); __sJT_st.setString(5,v_password_oblig); __sJT_st.setString(6,v_libreria_oblig); __sJT_st.setString(7,v_libd); /* // execute statement */  __sJT_ec.oracleExecuteUpdate(); /* // retrieve OUT parameters */  v_sw = __sJT_st.getInt(1); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException(); v_sistema_oblig = (String)__sJT_st.getString(3); v_usuario_oblig = (String)__sJT_st.getString(4); v_password_oblig = (String)__sJT_st.getString(5); v_libreria_oblig = (String)__sJT_st.getString(6); v_libd = (String)__sJT_st.getString(7); } finally { __sJT_ec.oracleClose(); } } /* //  ************************************************************ */  
         ...
         else
         {
             ...
             session.removeValue("v_saldoTOblig");
             session.putValue("v_saldoTOblig", String.valueOf(v_saldoTOblig));
             session.removeValue("v_saldoAVA");
             session.putValue("v_saldoAVA", v_saldoAVA);
             session.removeValue("v_saldoAVE");
             session.putValue("v_saldoAVE", v_saldoAVE);
            ...
            /*@lineinfo:generated-code*//*@lineinfo:179^13*/ /* //  ************************************************************ */ /* //  #sql { SELECT  to_char(LAST_DAY(to_date(:v_fecefe,'YYYY/MM/DD')),'YYYYMMDD') */ /* // */ /* //                     FROM DUAL }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); oracle.jdbc.OracleResultSet __sJT_rs = null; try { String theSqlTS = "SELECT  to_char(LAST_DAY(to_date( :1  ,'YYYY/MM/DD')),'YYYYMMDD')\n                                                                                                         \n                   FROM DUAL"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"3TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroOperativo_Oblig",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.setFetchSize(2); } /* // set IN parameters */  __sJT_st.setString(1,v_fecefe); /* // execute query */  __sJT_rs = __sJT_ec.oracleExecuteQuery(); if (__sJT_rs.getMetaData().getColumnCount() != 1) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(1,__sJT_rs.getMetaData().getColumnCount()); if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO(); /* // retrieve OUT parameters */  vfecha_act = (String)__sJT_rs.getString(1); if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO(); } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); } } /* //  ************************************************************ */  
         ...
         {                     
             ...
             session.removeValue("s_saldoava");
             session.putValue("s_saldoava", SaldosFinales[0].toString().replace(",","").replace("$",""));               
             session.removeValue("s_saldoave");
             session.putValue("s_saldoave", SaldosFinales[1].toString().replace(",","").replace("$",""));
             session.removeValue("s_comisionava");
             session.putValue("s_comisionava", comisiones[0]);
             session.removeValue("s_comisionave");
             session.putValue("s_comisionave", comisiones[1]);             
             session.removeValue("s_prov_comi_total_AVE");
             session.putValue("s_prov_comi_total_AVE", String.valueOf(SaldosFinales[19].toString().replace(",","").replace("$","")));
             session.removeValue("s_prov_comi_total_AVA");
             session.putValue("s_prov_comi_total_AVA", String.valueOf(SaldosFinales[18].toString().replace(",","").replace("$","")));
             
             session.removeValue("v_prov_comi_rend_AVA");
             session.putValue("v_prov_comi_rend_AVA", SaldosFinales[14].toString().replace(",","").replace("$",""));
             session.removeValue("v_prov_comi_capital_AVA");
             session.putValue("v_prov_comi_capital_AVA", SaldosFinales[15].toString().replace(",","").replace("$",""));
             
             session.removeValue("v_prov_comi_rend_AVE");
             session.putValue("v_prov_comi_rend_AVE", SaldosFinales[16].toString().replace(",","").replace("$",""));
             session.removeValue("v_prov_comi_capital_AVE");
             session.putValue("v_prov_comi_capital_AVE", SaldosFinales[17].toString().replace(",","").replace("$",""));
             
             session.removeValue("v_retencion_cont_AVA");
             session.putValue("v_retencion_cont_AVA", SaldosFinales[8].toString().replace(",","").replace("$",""));
             session.removeValue("v_retencion_rend_AVA");
             session.putValue("v_retencion_rend_AVA", SaldosFinales[10].toString().replace(",","").replace("$",""));
             
             session.removeValue("v_retencion_cont_AVE");
             session.putValue("v_retencion_cont_AVE", SaldosFinales[9].toString().replace(",","").replace("$",""));
             session.removeValue("v_retencion_rend_AVE");
             session.putValue("v_retencion_rend_AVE", SaldosFinales[11].toString().replace(",","").replace("$",""));
             
             session.removeValue("v_valorunidad_AVA");
             session.putValue("v_valorunidad_AVA", SaldosFinales[21].toString().replace(",","").replace("$",""));
             
             session.removeValue("v_valorunidad_AVE");
             session.putValue("v_valorunidad_AVE", SaldosFinales[22].toString().replace(",","").replace("$",""));
         }
         else
         {
             v_saldoTOblig = 0; 
        ...
        if( v_disponibleTOblig > 0 && v_saldoTOblig>0)
         ...
         {            
            ...
            out.println("<br>");
             ...
             out.println("<tr><td width = '20%' class=\"td11\" colspan= 4><center><font face='Verdana, Arial, Helvetica, sans-serif' size='1'><font color='#FFFFFF'><b><center>Método de Giro</center></b></font></td><td width = '80%'><select style='font-size: 11px; width:100%;' name=v_cuenta onchange='fillWords(v_cuenta.value)'>");
             ...
             String vsistemaoblig, vusuariooblig, vpasswordoblig, vlibreriaoblig = "";
                //SISTEMA
                /*@lineinfo:generated-code*//*@lineinfo:341^17*/ /* //  ************************************************************ */ /* //  #sql { SELECT REF_DESCRIPCION */ /* // */ /* //                      FROM TBREFERENCIAS */ /* //                      WHERE REF_CODIGO = 'SNM002' */ /* //                   }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); oracle.jdbc.OracleResultSet __sJT_rs = null; try { String theSqlTS = "SELECT REF_DESCRIPCION\n                     \n                    FROM TBREFERENCIAS\n                    WHERE REF_CODIGO = 'SNM002'"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"5TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroOperativo_Oblig",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.setFetchSize(2); } /* // execute query */  __sJT_rs = __sJT_ec.oracleExecuteQuery(); if (__sJT_rs.getMetaData().getColumnCount() != 1) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(1,__sJT_rs.getMetaData().getColumnCount()); if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO(); /* // retrieve OUT parameters */  vsistemaoblig = (String)__sJT_rs.getString(1); if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO(); } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); } } /* //  ************************************************************ */  
                ...
                //USUARIO
                /*@lineinfo:generated-code*//*@lineinfo:348^17*/ /* //  ************************************************************ */ /* //  #sql { SELECT REF_DESCRIPCION */ /* // */ /* //                      FROM TBREFERENCIAS */ /* //                      WHERE REF_CODIGO = 'SUM002' */ /* //                   }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); oracle.jdbc.OracleResultSet __sJT_rs = null; try { String theSqlTS = "SELECT REF_DESCRIPCION\n                     \n                    FROM TBREFERENCIAS\n                    WHERE REF_CODIGO = 'SUM002'"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"6TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroOperativo_Oblig",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.setFetchSize(2); } /* // execute query */  __sJT_rs = __sJT_ec.oracleExecuteQuery(); if (__sJT_rs.getMetaData().getColumnCount() != 1) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(1,__sJT_rs.getMetaData().getColumnCount()); if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO(); /* // retrieve OUT parameters */  vusuariooblig = (String)__sJT_rs.getString(1); if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO(); } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); } } /* //  ************************************************************ */  
               ...
               //PASSWORD
                /*@lineinfo:generated-code*//*@lineinfo:355^17*/ /* //  ************************************************************ */ /* //  #sql { SELECT REF_DESCRIPCION */ /* // */ /* //                      FROM TBREFERENCIAS */ /* //                      WHERE REF_CODIGO = 'SPM002' */ /* //                   }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); oracle.jdbc.OracleResultSet __sJT_rs = null; try { String theSqlTS = "SELECT REF_DESCRIPCION\n                     \n                    FROM TBREFERENCIAS\n                    WHERE REF_CODIGO = 'SPM002'"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"7TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroOperativo_Oblig",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.setFetchSize(2); } /* // execute query */  __sJT_rs = __sJT_ec.oracleExecuteQuery(); if (__sJT_rs.getMetaData().getColumnCount() != 1) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(1,__sJT_rs.getMetaData().getColumnCount()); if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO(); /* // retrieve OUT parameters */  vpasswordoblig = (String)__sJT_rs.getString(1); if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO(); } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); } } /* //  ************************************************************ */  
                ...
                //LIBRERIA
                /*@lineinfo:generated-code*//*@lineinfo:363^17*/ /* //  ************************************************************ */ /* //  #sql { SELECT REF_DESCRIPCION */ /* // */ /* //                      FROM TBREFERENCIAS */ /* //                      WHERE REF_CODIGO = 'SLO001' */ /* //                   }; */ /* //  ************************************************************ */  { /* // declare temps */  oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); oracle.jdbc.OracleResultSet __sJT_rs = null; try { String theSqlTS = "SELECT REF_DESCRIPCION\n                     \n                    FROM TBREFERENCIAS\n                    WHERE REF_CODIGO = 'SLO001'"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"8TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetiroOperativo_Oblig",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.setFetchSize(2); } /* // execute query */  __sJT_rs = __sJT_ec.oracleExecuteQuery(); if (__sJT_rs.getMetaData().getColumnCount() != 1) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(1,__sJT_rs.getMetaData().getColumnCount()); if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO(); /* // retrieve OUT parameters */  vlibreriaoblig = (String)__sJT_rs.getString(1); if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO(); } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); } } /* //  ************************************************************ */  
               ...
               //DIV CAPTURA CHEQUE TERCERO
                    ...
                    out.println("<center><b>Información de Tercero</b></center></font></font>");
                    out.println("</td></tr>");
                    out.println("<tr><td>");
              ...
              if(v_total.equals("N"))
              {
                  ...
                  out.println("</td><td>");
                  //TABLA 2
                      out.println("<table width=100% BORDER=2 BORDERCOLOR=SILVER style='border-collapse: collapse;'><tr><td class=\"td11\" colspan= 4><center><font face='Verdana, Arial, Helvetica, sans-serif' size='1'><font color='#FFFFFF' ><b>Orden de Aplicación</b></font></center></font></td></tr>");
                      out.println("<tr ><td >");
                      out.println("<pre><center><FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=2>");
