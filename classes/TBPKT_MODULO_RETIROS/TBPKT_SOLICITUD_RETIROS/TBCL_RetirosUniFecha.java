...
public class TBCL_RetirosUniFecha extends HttpServlet
{
 ...
 /*@lineinfo:generated-code*//*@lineinfo:36^2*/ /*//  *************************************************************//*//  SQLJ iterator declaration:*//*//  *************************************************************/ public static class i_cumple extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_cumple(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); CON_NOMBRESNdx = findColumn("CON_NOMBRES"); CON_APELLIDOSNdx = findColumn("CON_APELLIDOS"); v_fecha_cancelacionNdx = findColumn("v_fecha_cancelacion"); pro_retiro_minimoNdx = findColumn("pro_retiro_minimo"); PRO_DIAS_CANJENdx = findColumn("PRO_DIAS_CANJE"); CON_REF_TIPO_IDENTIFICACIONNdx = findColumn("CON_REF_TIPO_IDENTIFICACION"); CON_NUMERO_IDENTIFICACIONNdx = findColumn("CON_NUMERO_IDENTIFICACION"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public String CON_NOMBRES() throws java.sql.SQLException { return (String)m_rs.getString(CON_NOMBRESNdx); } private int CON_NOMBRESNdx; public String CON_APELLIDOS() throws java.sql.SQLException { return (String)m_rs.getString(CON_APELLIDOSNdx); } private int CON_APELLIDOSNdx; public String v_fecha_cancelacion() throws java.sql.SQLException { return (String)m_rs.getString(v_fecha_cancelacionNdx); } private int v_fecha_cancelacionNdx; public double pro_retiro_minimo() throws java.sql.SQLException { double __sJtmp = m_rs.getDouble(pro_retiro_minimoNdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int pro_retiro_minimoNdx; public int PRO_DIAS_CANJE() throws java.sql.SQLException { int __sJtmp = m_rs.getInt(PRO_DIAS_CANJENdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int PRO_DIAS_CANJENdx; public String CON_REF_TIPO_IDENTIFICACION() throws java.sql.SQLException { return (String)m_rs.getString(CON_REF_TIPO_IDENTIFICACIONNdx); } private int CON_REF_TIPO_IDENTIFICACIONNdx; public String CON_NUMERO_IDENTIFICACION() throws java.sql.SQLException { return (String)m_rs.getString(CON_NUMERO_IDENTIFICACIONNdx); } private int CON_NUMERO_IDENTIFICACIONNdx; } /*//  *************************************************************/ 
 ...
 /*@lineinfo:generated-code*//*@lineinfo:45^2*/ /*//  *************************************************************//*//  SQLJ iterator declaration:*//*//  *************************************************************/ public static class i_tipo extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_tipo(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); COT_DESCRIPCIONNdx = findColumn("COT_DESCRIPCION"); COT_REF_TIPO_TRANSACCIONNdx = findColumn("COT_REF_TIPO_TRANSACCION"); COT_REF_CLASE_TRANSACCIONNdx = findColumn("COT_REF_CLASE_TRANSACCION"); PRC_RETIRO_PENALIZADONdx = findColumn("PRC_RETIRO_PENALIZADO"); PRC_TRASLADONdx = findColumn("PRC_TRASLADO"); PRC_RETIRO_TOTALNdx = findColumn("PRC_RETIRO_TOTAL"); v_diasmenorNdx = findColumn("v_diasmenor"); v_diasmayorNdx = findColumn("v_diasmayor"); FECHA_EFECTIVANdx = findColumn("FECHA_EFECTIVA"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public String COT_DESCRIPCION() throws java.sql.SQLException { return (String)m_rs.getString(COT_DESCRIPCIONNdx); } private int COT_DESCRIPCIONNdx; public String COT_REF_TIPO_TRANSACCION() throws java.sql.SQLException { return (String)m_rs.getString(COT_REF_TIPO_TRANSACCIONNdx); } private int COT_REF_TIPO_TRANSACCIONNdx; public String COT_REF_CLASE_TRANSACCION() throws java.sql.SQLException { return (String)m_rs.getString(COT_REF_CLASE_TRANSACCIONNdx); } private int COT_REF_CLASE_TRANSACCIONNdx; public String PRC_RETIRO_PENALIZADO() throws java.sql.SQLException { return (String)m_rs.getString(PRC_RETIRO_PENALIZADONdx); } private int PRC_RETIRO_PENALIZADONdx; public String PRC_TRASLADO() throws java.sql.SQLException { return (String)m_rs.getString(PRC_TRASLADONdx); } private int PRC_TRASLADONdx; public String PRC_RETIRO_TOTAL() throws java.sql.SQLException { return (String)m_rs.getString(PRC_RETIRO_TOTALNdx); } private int PRC_RETIRO_TOTALNdx; public String v_diasmenor() throws java.sql.SQLException { return (String)m_rs.getString(v_diasmenorNdx); } private int v_diasmenorNdx; public String v_diasmayor() throws java.sql.SQLException { return (String)m_rs.getString(v_diasmayorNdx); } private int v_diasmayorNdx; public String FECHA_EFECTIVA() throws java.sql.SQLException { return (String)m_rs.getString(FECHA_EFECTIVANdx); } private int FECHA_EFECTIVANdx; } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:45^261*/
 ...
 /*@lineinfo:generated-code*//*@lineinfo:51^2*/ /*//  *************************************************************//*//  SQLJ iterator declaration:*//*//  *************************************************************/ public static class i_dias_c extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_dias_c(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); dias_canjeNdx = findColumn("dias_canje"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public int dias_canje() throws java.sql.SQLException { int __sJtmp = m_rs.getInt(dias_canjeNdx); if (m_rs.wasNull()) throw new sqlj.runtime.SQLNullException(); else return __sJtmp; } private int dias_canjeNdx; } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:51^53*/
 i_dias_c v_pac;
...
*/
  ...
  try
  {
   ...
   /*@lineinfo:generated-code*//*@lineinfo:172^4*/ /*//  *************************************************************//*//  #sql v_codusu = { values(TBFBD_REFERENCIAS(:v_tipousu,'UTU')) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TBFBD_REFERENCIAS( :2  ,'UTU') \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"0TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_tipousu); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_codusu = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:172^63*/
   /*@lineinfo:generated-code*//*@lineinfo:173^4*/ /*//  *************************************************************//*//  #sql v_coduni = { values(TBFBD_REFERENCIAS(:v_unidad,'UUP')) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TBFBD_REFERENCIAS( :2  ,'UUP') \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"1TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_unidad); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_coduni = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:173^62*/
   ...
   {//if usuario
    ...
    {//if unidad
     ...
     /*@lineinfo:generated-code*//*@lineinfo:186^6*/ /*//  *************************************************************//*//  #sql v_tipoci = { values(TB_FTIPO_CIERRE(:v_coduni)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TB_FTIPO_CIERRE( :2  ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"2TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_coduni); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_tipoci = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:186^57*/
     if(v_tipoci.equals("T"))
     { //if cierre
      /**Es cierre total entonces la fecha efectiva del retiro es proxima fecha habil*/
      /*@lineinfo:generated-code*//*@lineinfo:190^7*/ /*//  *************************************************************//*//  #sql v_fecha = { values(TB_FFECHA_SIGUIENTE(1)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TB_FFECHA_SIGUIENTE(1) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"3TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.DATE); } /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_fecha = (java.sql.Date)__sJT_st.getDate(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:190^53*/
      v_validafecha = true;
     }//cierre
     else
     {
      ...
      * se averigua que hora de cierre hay para la unidad y tipo de usuario*/
      /*@lineinfo:generated-code*//*@lineinfo:197^7*/ /*//  *************************************************************//*//  #sql { select to_char(sysdate,'HH24MI') FROM DUAL };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); oracle.jdbc.OracleResultSet __sJT_rs = null; try { String theSqlTS = "select to_char(sysdate,'HH24MI')  FROM DUAL"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"4TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.setFetchSize(2); } /*// execute query*/ __sJT_rs = __sJT_ec.oracleExecuteQuery(); if (__sJT_rs.getMetaData().getColumnCount() != 1) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(1,__sJT_rs.getMetaData().getColumnCount()); if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO(); /*// retrieve OUT parameters*/ v_hora = (String)__sJT_rs.getString(1); if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO(); } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:197^67*/
      /*@lineinfo:generated-code*//*@lineinfo:198^7*/ /*//  *************************************************************//*//  #sql v_horacie = { values(TB_FHORA_CIERRE(:v_producto,:v_coduni,:v_codusu)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TB_FHORA_CIERRE( :2  , :3  , :4  ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"5TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_producto); __sJT_st.setString(3,v_coduni); __sJT_st.setString(4,v_codusu); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_horacie = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:198^81*/
      if(!v_horacie.equals("ERROR"))
      {
       if( new Integer(v_hora).intValue() > new Integer(v_horacie).intValue())
       {
        ...
        /*@lineinfo:generated-code*//*@lineinfo:204^9*/ /*//  *************************************************************//*//  #sql v_fecha = { values(TB_FFECHA_SIGUIENTE(1)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TB_FFECHA_SIGUIENTE(1) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"6TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.DATE); } /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_fecha = (java.sql.Date)__sJT_st.getDate(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:204^55*/
        v_validafecha = true;
       }
       else
       {
        /**Queda el dia habil*/
        /*@lineinfo:generated-code*//*@lineinfo:210^9*/ /*//  *************************************************************//*//  #sql v_fecha = { values(TB_FFECHA_SIGUIENTE(0)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TB_FFECHA_SIGUIENTE(0) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"7TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.DATE); } /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_fecha = (java.sql.Date)__sJT_st.getDate(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:210^55*/
        v_validafecha = true;
       }
      }
      else
     ...
     if(v_validafecha)
     {
      ...
      /*@lineinfo:generated-code*//*@lineinfo:234^7*/ /*//  *************************************************************//*//  #sql v_cum = { SELECT  CON_NOMBRES*//*//                            ,CON_APELLIDOS*//*//                            ,TO_CHAR(CON_FECHA_CANCELACION,'YYYY-MM-DD') as v_fecha_cancelacion*//*//                            ,pro_retiro_minimo*//*//                            ,PRO_DIAS_CANJE*//*//                            ,CON_REF_TIPO_IDENTIFICACION*//*//                            ,CON_NUMERO_IDENTIFICACION*//*//                        FROM tbproductos,tbcontratos*//*//                       WHERE PRO_CODIGO     = CON_PRO_CODIGO*//*//                         AND CON_PRO_CODIGO = :v_producto*//*//                         AND CON_NUMERO     = :v_contrato*//*//                      };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "SELECT  CON_NOMBRES\n                          ,CON_APELLIDOS\n                          ,TO_CHAR(CON_FECHA_CANCELACION,'YYYY-MM-DD') as v_fecha_cancelacion\n                          ,pro_retiro_minimo\n                          ,PRO_DIAS_CANJE\n                          ,CON_REF_TIPO_IDENTIFICACION\n                          ,CON_NUMERO_IDENTIFICACION\n                      FROM tbproductos,tbcontratos\n                     WHERE PRO_CODIGO     = CON_PRO_CODIGO\n                       AND CON_PRO_CODIGO =  :1  \n                       AND CON_NUMERO     =  :2 "; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"8TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); /*// set IN parameters*/ __sJT_st.setString(1,v_producto); __sJT_st.setString(2,v_contrato); /*// execute query*/ v_cum = new TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha.i_cumple(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"8TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",null)); } finally { __sJT_ec.oracleCloseQuery(); } } /*//  *************************************************************/ 
     ...
     /**Cambio agregado por Marcela Ortiz Sandoval 
       ...
       * */
      /*@lineinfo:generated-code*//*@lineinfo:279^7*/ /*//  *************************************************************//*//  #sql v_pac = { select dias_canje from tbempresas_contratos, tbempresa_canje*//*//                     where emc_emp_grupo = emp_grupo*//*//                     and emc_con_pro_codigo = :v_producto*//*//                     and emc_con_numero = :v_contrato*//*//                      };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "select dias_canje from tbempresas_contratos, tbempresa_canje\n                   where emc_emp_grupo = emp_grupo \n                   and emc_con_pro_codigo =  :1  \n                   and emc_con_numero =  :2 "; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"9TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); /*// set IN parameters*/ __sJT_st.setString(1,v_producto); __sJT_st.setString(2,v_contrato); /*// execute query*/ v_pac = new TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha.i_dias_c(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"9TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",null)); } finally { __sJT_ec.oracleCloseQuery(); } } /*//  *************************************************************/ 
...
/* Final de la modificacion */
        ...
        {//3
         ...
         /*@lineinfo:generated-code*//*@lineinfo:368^10*/ /*//  *************************************************************//*//  #sql v_contrato_unif = { values(TBFBD_obtener_ref_unica(:v_producto,:v_contrato)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TBFBD_obtener_ref_unica( :2  , :3  ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"11TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_producto); __sJT_st.setString(3,v_contrato); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_contrato_unif = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:368^90*/
         ...
         /*@lineinfo:generated-code*//*@lineinfo:381^10*/ /*//  *************************************************************//*//  #sql v_tipo = { SELECT COT_DESCRIPCION*//*//                               ,COT_REF_TIPO_TRANSACCION*//*//                               ,COT_REF_CLASE_TRANSACCION*//*//                               ,PRC_RETIRO_PENALIZADO*//*//                               ,PRC_TRASLADO*//*//                               ,PRC_RETIRO_TOTAL*//*//                               ,TO_CHAR(PRC_DIAS_MENOR) v_diasmenor*//*//                               ,TO_CHAR(PRC_DIAS_MAYOR) v_diasmayor*//*//                               ,tbf_obtener_fechas_x_tranx(PRC_PRO_CODIGO, COT_REF_TIPO_TRANSACCION, COT_REF_CLASE_TRANSACCION) FECHA_EFECTIVA*//*//                           FROM TBPRODUCTOS_CONCEPTOS,TBCONCEPTOS_TRANSACCION*//*//                          WHERE PRC_PRO_CODIGO                = :v_producto*//*//                            AND PRC_COT_REF_TRANSACCION       = 'STR001'*//*//                            AND PRC_COT_REF_TRANSACCION       = COT_REF_TRANSACCION*//*//                            AND PRC_COT_REF_TIPO_TRANSACCION  = COT_REF_TIPO_TRANSACCION*//*//                            AND PRC_COT_REF_CLASE_TRANSACCION = COT_REF_CLASE_TRANSACCION*//*//                            AND PRC_ORIGEN_TAXB               = 'S'*//*//                       ORDER BY COT_DESCRIPCION };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "SELECT COT_DESCRIPCION\n                             ,COT_REF_TIPO_TRANSACCION\n                             ,COT_REF_CLASE_TRANSACCION\n                             ,PRC_RETIRO_PENALIZADO\n                             ,PRC_TRASLADO\n                             ,PRC_RETIRO_TOTAL\n                             ,TO_CHAR(PRC_DIAS_MENOR) v_diasmenor\n                             ,TO_CHAR(PRC_DIAS_MAYOR) v_diasmayor\n                             ,tbf_obtener_fechas_x_tranx(PRC_PRO_CODIGO, COT_REF_TIPO_TRANSACCION, COT_REF_CLASE_TRANSACCION) FECHA_EFECTIVA\n                         FROM TBPRODUCTOS_CONCEPTOS,TBCONCEPTOS_TRANSACCION\n                        WHERE PRC_PRO_CODIGO                =  :1  \n                          AND PRC_COT_REF_TRANSACCION       = 'STR001'\n                          AND PRC_COT_REF_TRANSACCION       = COT_REF_TRANSACCION\n                          AND PRC_COT_REF_TIPO_TRANSACCION  = COT_REF_TIPO_TRANSACCION\n                          AND PRC_COT_REF_CLASE_TRANSACCION = COT_REF_CLASE_TRANSACCION\n                          AND PRC_ORIGEN_TAXB               = 'S'\n                     ORDER BY COT_DESCRIPCION"; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"12TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",theSqlTS); /*// set IN parameters*/ __sJT_st.setString(1,v_producto); /*// execute query*/ v_tipo = new TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha.i_tipo(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"12TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_RetirosUniFecha",null)); } finally { __sJT_ec.oracleCloseQuery(); } } /*//  *************************************************************/ 
