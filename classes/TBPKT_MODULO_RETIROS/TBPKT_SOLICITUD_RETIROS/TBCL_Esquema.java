...
public class TBCL_Esquema extends HttpServlet
{
 ...
 /*@lineinfo:generated-code*//*@lineinfo:17^2*/ /*//  *************************************************************//*//  SQLJ iterator declaration:*//*//  *************************************************************/ class i_producto extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_producto(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); PRC_REF_METODO_ORDENNdx = findColumn("PRC_REF_METODO_ORDEN"); PRC_REF_METODO_BENEFICIONdx = findColumn("PRC_REF_METODO_BENEFICIO"); PRC_REF_METODO_PENALIZACIONNdx = findColumn("PRC_REF_METODO_PENALIZACION"); PRC_REF_METODO_CUENTANdx = findColumn("PRC_REF_METODO_CUENTA"); PRC_REF_NATURALEZANdx = findColumn("PRC_REF_NATURALEZA"); PRC_RESPETAR_NATURALEZANdx = findColumn("PRC_RESPETAR_NATURALEZA"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public String PRC_REF_METODO_ORDEN() throws java.sql.SQLException { return (String)m_rs.getString(PRC_REF_METODO_ORDENNdx); } private int PRC_REF_METODO_ORDENNdx; public String PRC_REF_METODO_BENEFICIO() throws java.sql.SQLException { return (String)m_rs.getString(PRC_REF_METODO_BENEFICIONdx); } private int PRC_REF_METODO_BENEFICIONdx; public String PRC_REF_METODO_PENALIZACION() throws java.sql.SQLException { return (String)m_rs.getString(PRC_REF_METODO_PENALIZACIONNdx); } private int PRC_REF_METODO_PENALIZACIONNdx; public String PRC_REF_METODO_CUENTA() throws java.sql.SQLException { return (String)m_rs.getString(PRC_REF_METODO_CUENTANdx); } private int PRC_REF_METODO_CUENTANdx; public String PRC_REF_NATURALEZA() throws java.sql.SQLException { return (String)m_rs.getString(PRC_REF_NATURALEZANdx); } private int PRC_REF_NATURALEZANdx; public String PRC_RESPETAR_NATURALEZA() throws java.sql.SQLException { return (String)m_rs.getString(PRC_RESPETAR_NATURALEZANdx); } private int PRC_RESPETAR_NATURALEZANdx; } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:17^210*/
 /**Itrator esquema retiro default contrato*/
 /*@lineinfo:generated-code*//*@lineinfo:19^2*/ /*//  *************************************************************//*//  SQLJ iterator declaration:*//*//  *************************************************************/ class i_contrato extends sqlj.runtime.ref.ResultSetIterImpl implements sqlj.runtime.NamedIterator { public i_contrato(sqlj.runtime.profile.RTResultSet resultSet) throws java.sql.SQLException { super(resultSet); CON_REF_METODO_ORDENNdx = findColumn("CON_REF_METODO_ORDEN"); CON_REF_METODO_BENEFICIONdx = findColumn("CON_REF_METODO_BENEFICIO"); CON_REF_METODO_PENALIZACIONNdx = findColumn("CON_REF_METODO_PENALIZACION"); CON_REF_METODO_CUENTANdx = findColumn("CON_REF_METODO_CUENTA"); CON_REF_NATURALEZANdx = findColumn("CON_REF_NATURALEZA"); CON_RESPETAR_NATURALEZANdx = findColumn("CON_RESPETAR_NATURALEZA"); m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet(); } private oracle.jdbc.OracleResultSet m_rs; public String CON_REF_METODO_ORDEN() throws java.sql.SQLException { return (String)m_rs.getString(CON_REF_METODO_ORDENNdx); } private int CON_REF_METODO_ORDENNdx; public String CON_REF_METODO_BENEFICIO() throws java.sql.SQLException { return (String)m_rs.getString(CON_REF_METODO_BENEFICIONdx); } private int CON_REF_METODO_BENEFICIONdx; public String CON_REF_METODO_PENALIZACION() throws java.sql.SQLException { return (String)m_rs.getString(CON_REF_METODO_PENALIZACIONNdx); } private int CON_REF_METODO_PENALIZACIONNdx; public String CON_REF_METODO_CUENTA() throws java.sql.SQLException { return (String)m_rs.getString(CON_REF_METODO_CUENTANdx); } private int CON_REF_METODO_CUENTANdx; public String CON_REF_NATURALEZA() throws java.sql.SQLException { return (String)m_rs.getString(CON_REF_NATURALEZANdx); } private int CON_REF_NATURALEZANdx; public String CON_RESPETAR_NATURALEZA() throws java.sql.SQLException { return (String)m_rs.getString(CON_RESPETAR_NATURALEZANdx); } private int CON_RESPETAR_NATURALEZANdx; } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:19^211*/
...
*/
    ...
    else if(v_esquema.equals("1"))/**Si el esquema escogido es el default contrato*/
         {
          ...
          /*@lineinfo:generated-code*//*@lineinfo:332^11*/ /*//  *************************************************************//*//  #sql v_contrato = { SELECT CON_REF_METODO_ORDEN*//*//                                     ,CON_REF_METODO_BENEFICIO*//*//                                     ,CON_REF_METODO_PENALIZACION*//*//                                     ,CON_REF_METODO_CUENTA*//*//                                     ,CON_REF_NATURALEZA*//*//                                     ,CON_RESPETAR_NATURALEZA*//*//                                 FROM tbcontratos*//*//                                WHERE CON_NUMERO = :v_contra*//*//                                  AND CON_PRO_CODIGO = :v_pro*//*//                                };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OraclePreparedStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "SELECT CON_REF_METODO_ORDEN\n                                   ,CON_REF_METODO_BENEFICIO\n                                   ,CON_REF_METODO_PENALIZACION\n                                   ,CON_REF_METODO_CUENTA\n                                   ,CON_REF_NATURALEZA\n                                   ,CON_RESPETAR_NATURALEZA\n                               FROM tbcontratos\n                              WHERE CON_NUMERO =  :1  \n                                AND CON_PRO_CODIGO =  :2 "; __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"2TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Esquema",theSqlTS); /*// set IN parameters*/ __sJT_st.setString(1,v_contra); __sJT_st.setString(2,v_pro); /*// execute query*/ v_contrato = new TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Esquema.i_contrato(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"2TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Esquema",null)); } finally { __sJT_ec.oracleCloseQuery(); } } /*//  *************************************************************/ 
   ...
   if(!v_esquema.equals("0"))
   {
      ...
      /*Cambio para manejo de referencia unica 2009/03/30 MOS */
      String v_contrato_unif = "";
      /*@lineinfo:generated-code*//*@lineinfo:472^7*/ /*//  *************************************************************//*//  #sql v_contrato_unif = { values(TBFBD_obtener_ref_unica(:v_pro,:v_contra)) };*//*//  *************************************************************/ { /*// declare temps*/ oracle.jdbc.OracleCallableStatement __sJT_st = null; sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX(); sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext()); try { String theSqlTS = "BEGIN :1 := TBFBD_obtener_ref_unica( :2  , :3  ) \n; END;"; __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"3TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Esquema",theSqlTS); if (__sJT_ec.isNew()) { __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR); } /*// set IN parameters*/ __sJT_st.setString(2,v_pro); __sJT_st.setString(3,v_contra); /*// execute statement*/ __sJT_ec.oracleExecuteUpdate(); /*// retrieve OUT parameters*/ v_contrato_unif = (String)__sJT_st.getString(1); } finally { __sJT_ec.oracleClose(); } } /*//  *************************************************************/ /*@lineinfo:user-code*//*@lineinfo:472^80*/
      out.println("<FONT color =#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Producto</b> "+v_pro+"    <b>Contrato</b>"+v_contrato_unif+" </center></font>");
      out.println("<FONT color=#000000 face='Verdana, Arial, Helvetica, sans-serif' size=1><CENTER><b>Nombres</b>  "+v_nom+"  <b> Apellidos </b>"+v_ape+" </CENTER></font>");
      out.println("<br>");
