...
implements sqlj.runtime.NamedIterator
{
  ...
  {
    super(resultSet);
    CIC_PRODUCTONdx = findColumn("CIC_PRODUCTO");
    CIC_CONTRATONdx = findColumn("CIC_CONTRATO");
    m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet();
  }
  private oracle.jdbc.OracleResultSet m_rs;
  public String CIC_PRODUCTO()
    throws java.sql.SQLException
  {
    return (String)m_rs.getString(CIC_PRODUCTONdx);
  }
  private int CIC_PRODUCTONdx;
  public String CIC_CONTRATO()
    throws java.sql.SQLException
  {
    return (String)m_rs.getString(CIC_CONTRATONdx);
  }
  private int CIC_CONTRATONdx;
}
...
/*@lineinfo:user-code*//*@lineinfo:23^60*/
 ...
 public int TBP_CALCULAR_UNIDADES_RETIRADAS(String v_fecha,int v_log)
 {
  ...
  try
  {
   ...
   /*@lineinfo:generated-code*//*@lineinfo:66^4*/
...

{
  ...
  try {
   String theSqlTS = "SELECT DISTINCT(CIC_CONTRATO)\n                             ,CIC_PRODUCTO\n                         FROM TBCI_CONTRATOS\n                        WHERE CIC_FECHA = TO_DATE( :1  ,'RRRR-MM-DD')";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"0TBPKT_CARGUE_APLICACION.TBC_CALCULAR_UNIRETIRADAS",theSqlTS);
   // set IN parameters
   __sJT_st.setString(1,v_fecha);
   // execute query
   v_contrato = new TBPKT_CARGUE_APLICACION.TBC_CALCULAR_UNIRETIRADAS.i_contrato(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"0TBPKT_CARGUE_APLICACION.TBC_CALCULAR_UNIRETIRADAS",null));
...
/*@lineinfo:user-code*//*@lineinfo:71^22*/
   ...
   while(v_contrato.next())
   {
     ...
     /*@lineinfo:generated-code*//*@lineinfo:80^6*/

//  ************************************************************
//  #sql v_indicador = { values(TB_FCALNUMUNIRET( :v_producto
//                                                     ,:vconnuevo
//                                                     ,:v_menretiro
//                                                     ,:v_log )) };
//  ************************************************************

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN :1 := TB_FCALNUMUNIRET(  :2  \n                                                   , :3  \n                                                   , :4  \n                                                   , :5   ) \n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"1TBPKT_CARGUE_APLICACION.TBC_CALCULAR_UNIRETIRADAS",theSqlTS);
   if (__sJT_ec.isNew())
   {
   ...
   __sJT_st.setString(3,vconnuevo);
   __sJT_st.setString(4,v_menretiro);
   __sJT_st.setInt(5,v_log);
  // execute statement
   __sJT_ec.oracleExecuteUpdate();
   // retrieve OUT parameters
   v_indicador = __sJT_st.getInt(1); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_menretiro = (String)__sJT_st.getString(4);
   v_log = __sJT_st.getInt(5); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
...
/*@lineinfo:user-code*//*@lineinfo:83^68*/
     ...
     if(!v_csaldoas400.trim().equals(""))
     {
      if(!v_csaldoas400.substring(0,5).equals("Error"))//error saldos
      {
       ...
       /*@lineinfo:generated-code*//*@lineinfo:108^8*/

//  ************************************************************
//  #sql v_indicador2 = { values(TB_FCALNUMAPO( :v_producto
//                                                  ,:vconnuevo
//                                                  ,:v_fecha
//                                                  ,:v_csaldo2
//                                                  ,:v_menaporte
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN :1 := TB_FCALNUMAPO(  :2  \n                                                , :3  \n                                                , :4  \n                                                , :5  \n                                                , :6  \n                                                , :7  \n                                                , :8  ) \n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"2TBPKT_CARGUE_APLICACION.TBC_CALCULAR_UNIRETIRADAS",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.INTEGER);
   ...
   __sJT_st.setString(2,v_producto);
   __sJT_st.setString(3,vconnuevo);
   __sJT_st.setString(4,v_fecha);
   __sJT_st.setDouble(5,v_csaldo2);
   __sJT_st.setString(6,v_menaporte);
   __sJT_st.setInt(7,v_log);
   __sJT_st.setInt(8,v_contadornumuni);
  // execute statement
   __sJT_ec.oracleExecuteUpdate();
   // retrieve OUT parameters
   v_indicador2 = __sJT_st.getInt(1); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_menaporte = (String)__sJT_st.getString(6);
   v_log = __sJT_st.getInt(7); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_contadornumuni = __sJT_st.getInt(8); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
  } finally { __sJT_ec.oracleClose(); }
}
...
/*@lineinfo:user-code*//*@lineinfo:152^17*/
    //#sql {ROLLBACK};
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TB_PLOG( 'CNUTAX'\n                       ,'Error en el proceso de calcular el numero de unidades retiradas'\n                       , :1  \n                       ,0\n                       , :2  )\n; END;";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"3TBPKT_CARGUE_APLICACION.TBC_CALCULAR_UNIRETIRADAS",theSqlTS);
   // set IN parameters
   __sJT_st.setString(1,v_men);
   __sJT_st.setInt(2,v_log);
  // execute statement
   __sJT_ec.oracleExecuteUpdate();
  } finally { __sJT_ec.oracleClose(); }
}
