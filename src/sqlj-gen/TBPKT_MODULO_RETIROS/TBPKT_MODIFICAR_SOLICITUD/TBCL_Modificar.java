...
/*@lineinfo:user-code*//*@lineinfo:20^183*/
 ...
 //TBCL_Validacion  i_valusu = new TBCL_Validacion()/**Instancia de la clase TBCL_GenerarBaseHTML*/
  ...
  try
  {
   ...
   if((java.lang.String)session.getAttribute("s_contrato")!= null ||(java.lang.String)session.getAttribute("s_producto")!= null)
   {
    ...
    /*@lineinfo:generated-code*//*@lineinfo:70^5*/
...

{
  ...
  try {
   ...
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"0TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_Modificar",theSqlTS);
   // set IN parameters
   __sJT_st.setString(1,v_pro);
   __sJT_st.setString(2,v_contra);
   __sJT_st.setString(3,v_pro);
   __sJT_st.setString(4,v_contra);
   // execute query
   v_retiro = new TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_Modificar.i_retiro(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"0TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_Modificar",null));
...
/*@lineinfo:user-code*//*@lineinfo:107^23*/

    /**Dibujar página de respuesta*/
    v_pintar=    STBCL_GenerarBaseHTML.TBFL_CABEZA("Modificar Solicitud de Retiro","Modificar Solicitud de Retiro","TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBS_Penalizacion","",true,"","");
...

{
  ...
  try {
   ...
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"1TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_Modificar",theSqlTS);
   if (__sJT_ec.isNew())
   {
...
/*@lineinfo:user-code*//*@lineinfo:125^80*/
