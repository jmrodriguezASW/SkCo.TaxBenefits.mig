...
public class TBCL_EliminarSol_Oblig extends HttpServlet{
    ...
    /*@lineinfo:generated-code*//*@lineinfo:17^5*/
...
/*@lineinfo:user-code*//*@lineinfo:17^142*/
...

{
  ...
  try {
   ...
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"0TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_EliminarSol_Oblig",theSqlTS);
   if (__sJT_ec.isNew())
   {
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "SELECT  ret_fecha_efectiva, \n                                RET_CONSECUTIVO, \n                                RET_VALOR, \n                                CON_NOMBRES, \n                                CON_APELLIDOS \n                        FROM TBRETIROS_OBLIG                        \n                        INNER JOIN TBCONTRATOS_OBLIG ON CON_PRO_CODIGO = RET_CON_PRO_CODIGO AND CON_NUMERO = RET_CON_NUMERO\n                        WHERE   RET_CON_PRO_CODIGO =  :1   \n                                AND RET_CON_NUMERO =  :2   \n                                AND RET_REF_ESTADO = 'SER001'";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"1TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_EliminarSol_Oblig",theSqlTS);
   // set IN parameters
   __sJT_st.setString(1,v_pro);
   __sJT_st.setString(2,v_contra);
   // execute query
   v_retiro = new TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_EliminarSol_Oblig.i_retiro(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"1TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_EliminarSol_Oblig",null));
...

{
  ...
  try {
   ...
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"2TBPKT_MODULO_RETIROS.TBPKT_MODIFICAR_SOLICITUD.TBCL_EliminarSol_Oblig",theSqlTS);
   if (__sJT_ec.isNew())
   {
