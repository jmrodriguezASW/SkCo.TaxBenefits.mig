...
public static class i_res2
extends sqlj.runtime.ref.ResultSetIterImpl
implements sqlj.runtime.NamedIterator
{
  public i_res2(sqlj.runtime.profile.RTResultSet resultSet)
    throws java.sql.SQLException
  {
    super(resultSet);
    ref_codigoNdx = findColumn("ref_codigo");
    ref_descripcionNdx = findColumn("ref_descripcion");
    v_porcentajeNdx = findColumn("v_porcentaje");
    m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet();
  }
  private oracle.jdbc.OracleResultSet m_rs;
  public String ref_codigo()
    throws java.sql.SQLException
  {
    return (String)m_rs.getString(ref_codigoNdx);
  }
  private int ref_codigoNdx;
  ...
  public String v_porcentaje()
    throws java.sql.SQLException
  {
    return (String)m_rs.getString(v_porcentajeNdx);
  }
  private int v_porcentajeNdx;
}
...
//  TBCL_FuncionesAs400 i_fondos   = new TBCL_FuncionesAs400();/**Instancia de la clase TBCL_FuncionesAs400*/
  ...
  {//3
   ...
   {//4
    ...
    //v_dim2           = (java.lang.String)session.getValue("s_dim");
    v_dim            = new Integer((java.lang.String)session.getValue("s_dim")).intValue();
...
//                                    ,tbreferencias
//                              WHERE MIF_PRO_CODIGO(+) = :v_pro
//                                and MIF_REF_FONDO (+) = ref_codigo
//                                and ref_valor = :v_codigoas
//                            };
//  ************************************************************

{
  ...
  try {
   String theSqlTS = "SELECT ref_codigo\n                                 ,ref_descripcion\n                                 ,to_char( nvl(MIF_PORCENTAJE,0)) v_porcentaje\n                             FROM tbminimos_fondo\n                                  ,tbreferencias\n                            WHERE MIF_PRO_CODIGO(+) =  :1  \n                              and MIF_REF_FONDO (+) = ref_codigo\n                              and ref_valor =  :2 ";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"0TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",theSqlTS);
   // set IN parameters
   __sJT_st.setString(1,v_pro);
   __sJT_st.setString(2,v_codigoas);
   // execute query
   v_res2 = new TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion.i_res2(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"0TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",null));
...
/*@lineinfo:user-code*//*@lineinfo:332^26*/
         ...
         {//10
          ...
          session.removeValue("s_codfon"+v_num+"");
          session.putValue("s_codfon"+v_num+"",(java.lang.Object)v_codfon);

          
          double  l      = new Double(v_fonsal2[y+1]).doubleValue();
          v_valort = l/100;
          /**Variable de session saldo del fondo */
          session.removeValue("s_valfon"+v_num+"");
          session.putValue("s_valfon"+v_num+"",(java.lang.Object)new Double(v_valort).toString());
...

{
  ...
  try {
   ...
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"1TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",theSqlTS);
   if (__sJT_ec.isNew())
   {
   ...
   __sJT_st.setString(3,v_codfon);
   // execute query
   __sJT_rs = __sJT_ec.oracleExecuteQuery();
   if (__sJT_rs.getMetaData().getColumnCount() != 1) sqlj.runtime.error.RuntimeRefErrors.raise_WRONG_NUM_COLS(1,__sJT_rs.getMetaData().getColumnCount());
   if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO();
   // retrieve OUT parameters
   v_sumval = __sJT_rs.getDouble(1); if (__sJT_rs.wasNull()) throw new sqlj.runtime.SQLNullException();
...
/*@lineinfo:user-code*//*@lineinfo:363^15*/
          ...
          session.removeValue("s_minfon"+v_num+"");
          session.putValue("s_minfon"+v_num+"",(java.lang.Object)v_res2.v_porcentaje());


          v_desfon =  v_res2.ref_descripcion();
          v_desc.addElement(v_desfon);
          /**Variable de session descripción del fondo */
          session.removeValue("s_desfon"+v_num+"");
          session.putValue("s_desfon"+v_num+"",(java.lang.Object)v_desfon);
          v_validarfondo = true;
         }//termina while  10
         v_res2.close();
         v_num++;
...
//         if(v_cumes2<v_diasmenor2)
       ...
       {//15
        ...
        {//16
         ...
         session.putValue("s_banco",v_cadblanco);
         session.putValue("s_cuenta",v_cadblanco);
...
//                                   AND con_numero = :v_contratotraslado
//                               };
//  ************************************************************

{
  ...
  try {
   ...
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"2TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",theSqlTS);
   // set IN parameters
   __sJT_st.setString(1,v_proti);
   __sJT_st.setString(2,v_contratotraslado);
   // execute query
   v_resp = new TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion.i_res(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"2TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",null));
  } finally { __sJT_ec.oracleCloseQuery(); }
}
...

{
  ...
  try {
   ...
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"3TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",theSqlTS);
   if (__sJT_ec.isNew())
   {
...
/*@lineinfo:user-code*//*@lineinfo:566^89*/
        ...
        if(v_total.equalsIgnoreCase("N"))
        {
         ...
         session.removeValue("s_tipov");
         session.putValue("s_tipov",v_tipov);
...

{
  ...
  try {
   ...
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"4TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",theSqlTS);
   if (__sJT_ec.isNew())
   {
     __sJT_st.setFetchSize(2);
   }
...
/*@lineinfo:user-code*//*@lineinfo:798^15*/
         ...
         session.removeValue("s_valor");
         session.putValue("s_valor",v_valor);
         ...
         session.putValue("s_fondo",v_distribucion);
         /**Si es a prorrata*/
...

{
  ...
  try {
   ...
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"5TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR);
   }
...

{
  ...
  oracle.jdbc.OracleResultSet __sJT_rs = null;
  try {
   String theSqlTS = "SELECT nvl(CON_REF_METODO_ORDEN,'X')\n                                   ,nvl(CON_REF_METODO_BENEFICIO,'X')\n                                   ,nvl(CON_REF_METODO_PENALIZACION,'X')\n                                   ,nvl(CON_REF_METODO_CUENTA,'X')\n                                   ,nvl(CON_REF_NATURALEZA,'X')\n                                   ,nvl(CON_RESPETAR_NATURALEZA,'X')\n                                \n                               FROM tbcontratos\n                              WHERE CON_NUMERO =  :1  \n                                AND CON_PRO_CODIGO =  :2 ";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"6TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",theSqlTS);
   if (__sJT_ec.isNew())
   {
     __sJT_st.setFetchSize(2);
   }
   ...
   if (!__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_NO_ROW_SELECT_INTO();
   // retrieve OUT parameters
   v_metodo_1 = (String)__sJT_rs.getString(1);
   v_metodo_2 = (String)__sJT_rs.getString(2);
   v_metodo_3 = (String)__sJT_rs.getString(3);
   v_metodo_4 = (String)__sJT_rs.getString(4);
   v_natcon_1 = (String)__sJT_rs.getString(5);
   v_resnat_1 = (String)__sJT_rs.getString(6);
   if (__sJT_rs.next()) sqlj.runtime.error.RuntimeRefErrors.raise_MULTI_ROW_SELECT_INTO();
  } finally { if (__sJT_rs!=null) __sJT_rs.close(); __sJT_ec.oracleClose(); }
}
...

{
  ...
  try {
   String theSqlTS = "BEGIN :1 := TBFBD_obtener_ref_unica( :2  , :3  ) \n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"7TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR);
   }
...

{
  ...
  try {
   String theSqlTS = "BEGIN :1 := TBFBD_obtener_ref_unica( :2  , :3  ) \n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"8TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR);
   }
...

{
  ...
  try {
   String theSqlTS = "BEGIN :1 := TBFBD_obtener_ref_unica( :2  , :3  ) \n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"9TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR);
   }
...

{
  ...
  try {
   String theSqlTS = "BEGIN :1 := TBFBD_obtener_ref_unica( :2  , :3  ) \n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"10TBPKT_MODULO_RETIROS.TBPKT_SOLICITUD_RETIROS.TBCL_Distribucion",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR);
   }
