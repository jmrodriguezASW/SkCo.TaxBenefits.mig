 ...
 public void TBPL_Esquema(HttpSession session,HttpServletRequest request,PrintWriter out,String nuevaCadena )
 {
  ...
  try
  {
   ...
   if((java.lang.String)session.getValue("s_contrato") != null ||(java.lang.String)session.getValue("s_producto") != null)
   {
    ...
    v_nom     = (java.lang.String)session.getValue("s_nombres");/**Tomar nombre del afiliado*/
    v_ape     = (java.lang.String)session.getValue("s_apellidos");/**Tomar apellido del afiliado*/
    v_reftipo = (java.lang.String)session.getValue("s_tipotran");//**Tomar tipo de transacción*/
    v_refclase= (java.lang.String)session.getValue("s_clasetran");//**Tomar clase de transacción*/
    v_fondo   =(java.lang.String)session.getValue("s_fondo");
    ...
    session.removeValue("s_maximo2");
    session.putValue("s_maximo2",v_maximo2);
...
/*@lineinfo:user-code*//*@lineinfo:171^11*/
        ...
        session.putValue("s_valorcli"+i+"",String.valueOf(Double.parseDouble(v_valorcli)/v_cargomil));
        }
        else {
          session.removeValue("s_valorcli"+i+"");
