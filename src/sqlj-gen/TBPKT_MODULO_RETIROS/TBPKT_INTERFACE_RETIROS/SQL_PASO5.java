...
/*@lineinfo:user-code*//*@lineinfo:96^51*/
...
/*@lineinfo:user-code*//*@lineinfo:111^61*/
        ...
        if (v_valido.equals("S")){
          ...
          //el paso 5
          //**************************************************************
          /*@lineinfo:generated-code*//*@lineinfo:131^11*/
...
/*@lineinfo:user-code*//*@lineinfo:134^77*/
          ...
          if ( v_cod_err == 0 ){
            ...
            if (v_proceso == 0){//proceso 0
              ...
              /*@lineinfo:generated-code*//*@lineinfo:148^15*/
...
/*@lineinfo:user-code*//*@lineinfo:151^83*/
              out.println("Borrado tbinterface_logs");
              /*@lineinfo:generated-code*//*@lineinfo:153^15*/
...
/*@lineinfo:user-code*//*@lineinfo:155^51*/
              out.println("Borrado tbinterface_retiros");


              /*@lineinfo:generated-code*//*@lineinfo:159^15*/
...
/*@lineinfo:user-code*//*@lineinfo:163^21*/
              ...
              /*@lineinfo:generated-code*//*@lineinfo:166^15*/
...
/*@lineinfo:user-code*//*@lineinfo:170^28*/
...
/*@lineinfo:user-code*//*@lineinfo:172^44*/
...
/*@lineinfo:user-code*//*@lineinfo:173^28*/
...
/*@lineinfo:user-code*//*@lineinfo:175^44*/
              /*@lineinfo:generated-code*//*@lineinfo:176^15*/
...
/*@lineinfo:user-code*//*@lineinfo:176^28*/
            ...
            /************  proceso 1 insertar en tabla de control********************/
             ...
             {//proceso 1
               ...
               while ((v_proceso_exitoso.equals("N")) && (v_cont <= v_veces))
               {
                v_cod_err = 0;
                v_men_err = " ";
                /*@lineinfo:generated-code*//*@lineinfo:191^17*/
...
/*@lineinfo:user-code*//*@lineinfo:194^57*/
...
/*@lineinfo:user-code*//*@lineinfo:213^76*/
              ...
              if (v_cod_err == 0){
                ...
                if (v_proceso == 2 ){
                  ...
                  while ((v_proceso_exitoso.equals("N")) && (v_cont <= v_veces)) {
                    ...
                    --*/
                    /*@lineinfo:generated-code*//*@lineinfo:293^21*/
...
/*@lineinfo:user-code*//*@lineinfo:295^61*/
                    //vreg_retiro.close();

                    if (v_cod_err != 0 ){
                      /*@lineinfo:generated-code*//*@lineinfo:299^23*/
...
/*@lineinfo:user-code*//*@lineinfo:299^37*/
                      v_cont            = v_cont + 1;
                      v_proceso_exitoso = "N";
                    }
                    else{
                      /*@lineinfo:generated-code*//*@lineinfo:304^23*/
...
/*@lineinfo:user-code*//*@lineinfo:310^69*/
                      v_proceso_exitoso = "S";
                      v_proceso          = 3;
                      /*@lineinfo:generated-code*//*@lineinfo:313^23*/
...
/*@lineinfo:user-code*//*@lineinfo:313^35*/
                    }
                ...
                if ((v_proceso >= 3) && (v_proceso < 9))  {
                  ...
                  while ((v_proceso_exitoso.equals("N")) && (v_cont <= v_veces)) {
                    ...
                    /*@lineinfo:generated-code*//*@lineinfo:335^21*/
...
/*@lineinfo:user-code*//*@lineinfo:338^61*/
                ...
                if (v_proceso == 9)
                 {
                  ...
                  /*@lineinfo:generated-code*//*@lineinfo:362^19*/
...
/*@lineinfo:user-code*//*@lineinfo:373^88*/
                   ...
                   if (v_cod_err == 0) // si no hubo error
                   {
                     if (v_existe_paso == 0) // El paso 5 no existe
                     {
                       ...
                       /*@lineinfo:generated-code*//*@lineinfo:380^24*/
...
/*@lineinfo:user-code*//*@lineinfo:386^71*/

                      if(v_cod_err == 0 ) // si no hubo error
                      {
                        /*@lineinfo:generated-code*//*@lineinfo:390^25*/
...
/*@lineinfo:user-code*//*@lineinfo:390^37*/
                        v_existe_paso = 5;
                        v_estado_paso = "Y";
                      }
                     }
                     else  // El paso 5 ya existe
                     {
                        ...
                        /*@lineinfo:generated-code*//*@lineinfo:398^25*/
...
/*@lineinfo:user-code*//*@lineinfo:402^92*/
                     }//existe paso
                   }//codigo de error
                  }//codigo erro uni
...
/*@lineinfo:user-code*//*@lineinfo:425^34*/
                     /*@lineinfo:generated-code*//*@lineinfo:426^22*/
...
/*@lineinfo:user-code*//*@lineinfo:432^66*/
                    }//1
                    else
                    {//1
...
/*@lineinfo:user-code*//*@lineinfo:440^34*/
                     /*@lineinfo:generated-code*//*@lineinfo:441^22*/
...
/*@lineinfo:user-code*//*@lineinfo:447^66*/
                     }//1
                   }//No hubo error al Seleccionar de parametros de Multifund 0
                  }//
                  else
                  {
                      /*@lineinfo:generated-code*//*@lineinfo:453^23*/
...
/*@lineinfo:user-code*//*@lineinfo:453^35*/
                     /*@lineinfo:generated-code*//*@lineinfo:454^22*/
...
/*@lineinfo:user-code*//*@lineinfo:460^66*/
          ...
          if (v_cod_err == 0)
          {
            ...
            {
              /*@lineinfo:generated-code*//*@lineinfo:481^15*/
...
/*@lineinfo:user-code*//*@lineinfo:487^59*/
              /*@lineinfo:generated-code*//*@lineinfo:488^15*/
...
/*@lineinfo:user-code*//*@lineinfo:488^27*/
            }
            else
            {
              /*@lineinfo:generated-code*//*@lineinfo:492^15*/
...
/*@lineinfo:user-code*//*@lineinfo:495^82*/
              /*@lineinfo:generated-code*//*@lineinfo:496^15*/
...
/*@lineinfo:user-code*//*@lineinfo:496^27*/
            }
          ...
          else
          {
            ...
            if (v_consecutivo_log == 0)
            {
              /*@lineinfo:generated-code*//*@lineinfo:505^15*/
...
/*@lineinfo:user-code*//*@lineinfo:511^59*/
              /*@lineinfo:generated-code*//*@lineinfo:512^15*/
...
/*@lineinfo:user-code*//*@lineinfo:512^27*/
            }
            else
            {
              /*@lineinfo:generated-code*//*@lineinfo:516^15*/
...
/*@lineinfo:user-code*//*@lineinfo:519^80*/
              /*@lineinfo:generated-code*//*@lineinfo:520^15*/
...
/*@lineinfo:user-code*//*@lineinfo:527^42*/
            /*@lineinfo:generated-code*//*@lineinfo:528^13*/
...
/*@lineinfo:user-code*//*@lineinfo:528^25*/
            out.println("Borro");
    ...
    catch (Exception e)
    {
     ...
     try
     {
       ...
       /*@lineinfo:generated-code*//*@lineinfo:566^8*/
...
/*@lineinfo:user-code*//*@lineinfo:572^57*/
       /*@lineinfo:generated-code*//*@lineinfo:573^8*/
...
/*@lineinfo:user-code*//*@lineinfo:573^20*/
       out.close();
       }
      catch (Exception e1)
      {
