...
{
  /*@lineinfo:generated-code*//*@lineinfo:27^3*/

//  ************************************************************
//  SQLJ iterator declaration:
//  ************************************************************

public static class vinter_tbcierre
extends sqlj.runtime.ref.ResultSetIterImpl
implements sqlj.runtime.NamedIterator
{
  public vinter_tbcierre(sqlj.runtime.profile.RTResultSet resultSet)
    throws java.sql.SQLException
  {
    super(resultSet);
    cie_ref_unidad_procesoNdx = findColumn("cie_ref_unidad_proceso");
    cie_fechaNdx = findColumn("cie_fecha");
    cie_tipoNdx = findColumn("cie_tipo");
    m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet();
  }
  private oracle.jdbc.OracleResultSet m_rs;
  public String cie_ref_unidad_proceso()
    throws java.sql.SQLException
  {
    return (String)m_rs.getString(cie_ref_unidad_procesoNdx);
  }
  private int cie_ref_unidad_procesoNdx;
  public java.sql.Date cie_fecha()
    throws java.sql.SQLException
  {
    return (java.sql.Date)m_rs.getDate(cie_fechaNdx);
  }
  private int cie_fechaNdx;
  public String cie_tipo()
    throws java.sql.SQLException
  {
    return (String)m_rs.getString(cie_tipoNdx);
  }
  private int cie_tipoNdx;
}
...
public static class vinter_unidades
extends sqlj.runtime.ref.ResultSetIterImpl
implements sqlj.runtime.NamedIterator
{
  public vinter_unidades(sqlj.runtime.profile.RTResultSet resultSet)
    throws java.sql.SQLException
  {
    super(resultSet);
...
/*@lineinfo:user-code*//*@lineinfo:28^91*/
  /*@lineinfo:generated-code*//*@lineinfo:29^3*/

//  ************************************************************
//  SQLJ iterator declaration:
//  ************************************************************

public static class vinter_productos
extends sqlj.runtime.ref.ResultSetIterImpl
implements sqlj.runtime.NamedIterator
{
  public vinter_productos(sqlj.runtime.profile.RTResultSet resultSet)
    throws java.sql.SQLException
  {
    super(resultSet);
    pro_descripcionNdx = findColumn("pro_descripcion");
  ...
  public String pro_descripcion()
    throws java.sql.SQLException
  {
    return (String)m_rs.getString(pro_descripcionNdx);
  }
  private int pro_descripcionNdx;
...
//                              ORDER BY  tc.cie_ref_unidad_proceso, tc.cie_fecha  };
//  ************************************************************

{
  ...
  try {
   String theSqlTS = "SELECT tc.cie_fecha, tc.cie_ref_unidad_proceso, tc.cie_tipo\n                            FROM tbreferencias, tbcierres tc\n                            WHERE tc.cie_fecha = ( SELECT MAX(cie_fecha)\n                                                  FROM tbcierres\n                                                  WHERE cie_ref_unidad_proceso = tc.cie_ref_unidad_proceso AND CIE_TIPO='T')\n                              AND ref_codigo   = cie_ref_unidad_proceso\n                              AND ref_codigo LIKE 'UUP%'\n                              AND ref_codigo NOT LIKE 'UUP000'\n                              AND ref_codigo NOT LIKE 'UUP099'\n                              AND ref_valor IS NOT NULL\n                            ORDER BY  tc.cie_ref_unidad_proceso, tc.cie_fecha";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"0TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_CIERRE",theSqlTS);
   // execute query
   v_tbcierres = new TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_CIERRE.vinter_tbcierre(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"0TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_CIERRE",null));
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "SELECT ref_descripcion, ref_codigo\n                            FROM tbreferencias\n                            WHERE ref_codigo LIKE 'UUP%'\n                              AND ref_codigo NOT LIKE 'UUP000'\n                              AND ref_codigo NOT LIKE 'UUP099'\n                              AND ref_valor  IS NOT NULL";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"1TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_CIERRE",theSqlTS);
   // execute query
   v_unidades = new TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_CIERRE.vinter_unidades(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"1TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_CIERRE",null));
  } finally { __sJT_ec.oracleCloseQuery(); }
}
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "SELECT pro_descripcion, pro_codigo\n                            FROM tbproductos";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"2TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_CIERRE",theSqlTS);
   // execute query
   v_productos = new TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_CIERRE.vinter_productos(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"2TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_CIERRE",null));
  } finally { __sJT_ec.oracleCloseQuery(); }
}
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TBPBD_FECHA_CIERRE_VALIDA( :1  )\n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"3TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
  ...
  // execute statement
   ...
   v_fecha = (String)__sJT_st.getString(1);
