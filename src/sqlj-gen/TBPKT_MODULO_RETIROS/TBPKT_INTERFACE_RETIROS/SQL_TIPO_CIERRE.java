...
public static class vinter_fecha
extends sqlj.runtime.ref.ResultSetIterImpl
implements sqlj.runtime.NamedIterator
{
  public vinter_fecha(sqlj.runtime.profile.RTResultSet resultSet)
    throws java.sql.SQLException
  {
    super(resultSet);
    fecha_cierreNdx = findColumn("fecha_cierre");
    m_rs = (oracle.jdbc.OracleResultSet) resultSet.getJDBCResultSet();
  }
  private oracle.jdbc.OracleResultSet m_rs;
  public Integer fecha_cierre()
    throws java.sql.SQLException
  {
    Integer __sJtmp = new Integer(m_rs.getInt(fecha_cierreNdx));
    if (m_rs.wasNull()) __sJtmp = null; return __sJtmp;
  }
  private int fecha_cierreNdx;
}


//  ************************************************************

/*@lineinfo:user-code*//*@lineinfo:25^64*/
...

{
  ...
  try {
   String theSqlTS = "SELECT TO_NUMBER(SUBSTR( :1  ,1,4)||SUBSTR( :2  ,6,2)||SUBSTR( :3  ,9,2))\n                                AS   fecha_cierre\n                                FROM DUAL";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"0TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   // set IN parameters
   __sJT_st.setString(1,v_fechac);
   __sJT_st.setString(2,v_fechac);
   __sJT_st.setString(3,v_fechac);
   // execute query
   v_fecha_cierre = new TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE.vinter_fecha(new sqlj.runtime.ref.OraRTResultSet(__sJT_ec.oracleExecuteQuery(),__sJT_st,"0TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",null));
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN :1 := TBFBD_VALIDAR_CIERRE_ANT ( :2  ,\n                                                              :3  ,\n                                                              :4  ,\n                                                              :5  ,\n                                                              :6  ) \n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"1TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
      ...
      __sJT_st.registerOutParameter(6,oracle.jdbc.OracleTypes.INTEGER);
   }
   // set IN parameters
   __sJT_st.setInt(2,v_retiros);
   __sJT_st.setInt(3,v_distribucion);
   __sJT_st.setString(4,v_cod_unidad);
   if (v_fecha == null) __sJT_st.setNull(5,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(5,v_fecha.intValue());
   __sJT_st.setInt(6,v_cod_err);
  // execute statement
   __sJT_ec.oracleExecuteUpdate();
   // retrieve OUT parameters
   v_val_cierre = (String)__sJT_st.getString(1);
   v_retiros = __sJT_st.getInt(2); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_distribucion = __sJT_st.getInt(3); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_cod_unidad = (String)__sJT_st.getString(4);
   v_fecha = new Integer(__sJT_st.getInt(5)); if (__sJT_st.wasNull()) v_fecha = null;
   v_cod_err = __sJT_st.getInt(6); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN :1 := TBFBD_VALIDAR_CIERRE( :2  ,  :3  ,  :4  , 1,  :5  ,  :6  ,  :7  )  \n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"2TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.VARCHAR);
      __sJT_st.registerOutParameter(6,oracle.jdbc.OracleTypes.INTEGER);
   ...
   // set IN parameters
   if (v_fecha == null) __sJT_st.setNull(2,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(2,v_fecha.intValue());
   __sJT_st.setString(3,v_coduni);
   __sJT_st.setString(4,v_producto);
   __sJT_st.setString(5,v_tipcierre);
   __sJT_st.setInt(6,v_cod_err);
   __sJT_st.setString(7,v_men_err);
  // execute statement
   __sJT_ec.oracleExecuteUpdate();
   // retrieve OUT parameters
   v_val_cierre = (String)__sJT_st.getString(1);
   v_cod_err = __sJT_st.getInt(6); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_men_err = (String)__sJT_st.getString(7);
  } finally { __sJT_ec.oracleClose(); }
}
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TBPBD_UPDATE_RETIROST0 ( :1  ,  :2  ,  :3  ) \n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"3TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(2,oracle.jdbc.OracleTypes.INTEGER);
   ...
   // set IN parameters
   if (v_fecha == null) __sJT_st.setNull(1,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(1,v_fecha.intValue());
...

{
  ...
  sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX();
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
   String theSqlTS = "DELETE FROM c3aicpp@mfund";
   __sJT_st = __sJT_ec.prepareOracleBatchableStatement(__sJT_cc,"4TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
  // execute statement
...

{
  ...
  sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX();
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
   String theSqlTS = "DELETE FROM ajkmcpp@mfund";
   __sJT_st = __sJT_ec.prepareOracleBatchableStatement(__sJT_cc,"5TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
  // execute statement
   __sJT_ec.oracleExecuteBatchableUpdate();
}
...

{
  ...
  sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX();
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
   String theSqlTS = "DELETE FROM ajkncpp@mfund where kngldz<> :1 ";
   __sJT_st = __sJT_ec.prepareOracleBatchableStatement(__sJT_cc,"6TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   // set IN parameters
   if (v_fecha == null) __sJT_st.setNull(1,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(1,v_fecha.intValue());
  // execute statement
   __sJT_ec.oracleExecuteBatchableUpdate();
...

{
  ...
  sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX();
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
   String theSqlTS = "DELETE FROM c3ajcpp@mfund";
   __sJT_st = __sJT_ec.prepareOracleBatchableStatement(__sJT_cc,"7TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
  // execute statement
   __sJT_ec.oracleExecuteBatchableUpdate();
}
...

{
  ...
  sqlj.runtime.ref.DefaultContext __sJT_cc = sqlj.runtime.ref.DefaultContext.getDefaultContext(); if (__sJT_cc==null) sqlj.runtime.error.RuntimeRefErrors.raise_NULL_CONN_CTX();
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
   String theSqlTS = "DELETE FROM AJKPCPP@MFUND WHERE KPQGNU = 1 AND KPMECX = '000001'";
   __sJT_st = __sJT_ec.prepareOracleBatchableStatement(__sJT_cc,"8TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
  // execute statement
   __sJT_ec.oracleExecuteBatchableUpdate();
}
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TBPBD_CARGAR ( :1  ,  :2  ,  :3  , '1',  :4  ,  :5  ,  :6  ,  :7  ,  :8  ,  :9  )\n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"9TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
   ...
   // set IN parameters
   __sJT_st.setString(1,v_coduni);
   __sJT_st.setString(2,v_producto);
   if (v_fecha == null) __sJT_st.setNull(3,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(3,v_fecha.intValue());
   __sJT_st.setInt(4,v_proceso);
   __sJT_st.setInt(5,v_retiros);
   __sJT_st.setInt(6,v_distribucion);
   __sJT_st.setInt(7,v_total_reg);
   __sJT_st.setInt(8,v_cod_err);
   __sJT_st.setString(9,v_men_err);
  // execute statement
   __sJT_ec.oracleExecuteUpdate();
   // retrieve OUT parameters
   v_proceso = __sJT_st.getInt(4); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_retiros = __sJT_st.getInt(5); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_distribucion = __sJT_st.getInt(6); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_total_reg = __sJT_st.getInt(7); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_cod_err = __sJT_st.getInt(8); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_men_err = (String)__sJT_st.getString(9);
  } finally { __sJT_ec.oracleClose(); }
}
...

{
  ...
  try {
   String theSqlTS = "BEGIN TBPBD_CARGAR ( :1  ,  :2  ,  :3  , '1',  :4  ,  :5  ,  :6  ,  :7  ,  :8  ,  :9  )\n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"10TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(4,oracle.jdbc.OracleTypes.INTEGER);
      __sJT_st.registerOutParameter(5,oracle.jdbc.OracleTypes.INTEGER);
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TBPBD_UPDATE_AJKPCPP( :1  ,  :2  , 1,  :3  ,  :4  )\n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"11TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(3,oracle.jdbc.OracleTypes.INTEGER);
      __sJT_st.registerOutParameter(4,oracle.jdbc.OracleTypes.VARCHAR);
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TBPBD_DEL_AJKPCPP_E( :1  ,  :2  , 1,  :3  ,  :4  )\n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"12TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(3,oracle.jdbc.OracleTypes.INTEGER);
      __sJT_st.registerOutParameter(4,oracle.jdbc.OracleTypes.VARCHAR);
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN :1 := TBFBD_VERIFICAR_PASO1( :2  ,  :3  ,  :4  )  \n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"13TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
  ...
  // execute statement
   __sJT_ec.oracleExecuteUpdate();
   // retrieve OUT parameters
   ct = __sJT_st.getInt(1); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TBPBD_UPDATE_AJKPCPP( :1  , 'UUP099', 1,  :2  ,  :3  )\n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"14TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(2,oracle.jdbc.OracleTypes.INTEGER);
      __sJT_st.registerOutParameter(3,oracle.jdbc.OracleTypes.VARCHAR);
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TBPBD_UPDATE_TBCIERRES ( :1  ,  :2  ,  :3  ,  :4  ,  :5  )\n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"15TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(4,oracle.jdbc.OracleTypes.INTEGER);
   ...
   __sJT_st.setString(1,v_coduni);
   if (v_fecha == null) __sJT_st.setNull(2,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(2,v_fecha.intValue());
   __sJT_st.setString(3,v_tipcierre);
   __sJT_st.setInt(4,v_cod_err);
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TBPBD_UPDATE_INTERF_RETIROS( :1  , '1',  :2  ,  :3  ,  :4  )\n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"16TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(3,oracle.jdbc.OracleTypes.INTEGER);
      __sJT_st.registerOutParameter(4,oracle.jdbc.OracleTypes.VARCHAR);
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TBPBD_UPDATE_INTERF_DISTR( :1  , '1',  :2  ,  :3  ,  :4  )\n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"17TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(3,oracle.jdbc.OracleTypes.INTEGER);
      __sJT_st.registerOutParameter(4,oracle.jdbc.OracleTypes.VARCHAR);
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TBPBD_COMMIT( :1  ,  :2   )\n; END;";
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"18TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   if (__sJT_ec.isNew())
   {
      __sJT_st.registerOutParameter(1,oracle.jdbc.OracleTypes.INTEGER);
   ...
   // set IN parameters
   __sJT_st.setInt(1,v_cod_err);
   __sJT_st.setString(2,v_men_err);
  // execute statement
   __sJT_ec.oracleExecuteUpdate();
   // retrieve OUT parameters
   v_cod_err = __sJT_st.getInt(1); if (__sJT_st.wasNull()) throw new sqlj.runtime.SQLNullException();
   v_men_err = (String)__sJT_st.getString(2);
  } finally { __sJT_ec.oracleClose(); }
}
...

{
  ...
  sqlj.runtime.ExecutionContext.OracleContext __sJT_ec = ((__sJT_cc.getExecutionContext()==null) ? sqlj.runtime.ExecutionContext.raiseNullExecCtx() : __sJT_cc.getExecutionContext().getOracleContext());
  try {
   String theSqlTS = "BEGIN TBPBD_INS_TBINTERFACE_LOGS('EG', to_date( :1  ,'RRRR-MM-DD'), 'P1',  :2  , to_char( :3  ), 'MFUND', 0)\n; END;";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"19TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   // set IN parameters
   if (v_fecha == null) __sJT_st.setNull(1,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(1,v_fecha.intValue());
   __sJT_st.setString(2,v_mensajeLog);
   __sJT_st.setInt(3,v_total_reg);
  // execute statement
   __sJT_ec.oracleExecuteUpdate();
  } finally { __sJT_ec.oracleClose(); }
}
...

{
  ...
  try {
   String theSqlTS = "BEGIN TBPBD_INS_TBINTERFACE_LOGS('EG', to_date( :1  ,'RRRR-MM-DD'), 'P1',  :2  , to_char( :3  ), 'MFUND', 0)\n; END;";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"20TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   // set IN parameters
   if (v_fecha == null) __sJT_st.setNull(1,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(1,v_fecha.intValue());
   __sJT_st.setString(2,v_mensajeLog);
   __sJT_st.setInt(3,v_total_reg);
...

{
  ...
  try {
   String theSqlTS = "BEGIN TBPBD_INS_TBINTERFACE_LOGS('EG', to_date( :1  ,'RRRR-MM-DD'), 'P1',  :2  , to_char( :3  ), 'MFUND', 0)\n; END;";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"21TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   // set IN parameters
   if (v_fecha == null) __sJT_st.setNull(1,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(1,v_fecha.intValue());
   __sJT_st.setString(2,v_mensajeLog);
   __sJT_st.setInt(3,v_total_reg);
...

{
  ...
  try {
   String theSqlTS = "BEGIN TBPBD_INS_TBINTERFACE_LOGS('EG', to_date( :1  ,'RRRR-MM-DD'), 'P1',  :2  , to_char( :3  ), 'MFUND', 0)\n; END;";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"22TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   // set IN parameters
   if (v_fecha == null) __sJT_st.setNull(1,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(1,v_fecha.intValue());
   __sJT_st.setString(2,v_mensajeLog);
   __sJT_st.setInt(3,v_total_reg);
...

{
  ...
  try {
   String theSqlTS = "BEGIN TBPBD_INS_TBINTERFACE_LOGS('EG', to_date( :1  ,'RRRR-MM-DD'), 'P1',  :2  , to_char( :3  ), 'MFUND', 0)\n; END;";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"23TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   // set IN parameters
   if (v_fecha == null) __sJT_st.setNull(1,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(1,v_fecha.intValue());
   __sJT_st.setString(2,v_mensajeLog);
   __sJT_st.setInt(3,v_total_reg);
...

{
  ...
  try {
   String theSqlTS = "BEGIN TBPBD_INS_TBINTERFACE_LOGS('EG', to_date( :1  ,'RRRR-MM-DD'), 'P1',  :2  , to_char( :3  ), 'MFUND', 0)\n; END;";
   __sJT_st = __sJT_ec.prepareOracleStatement(__sJT_cc,"24TBPKT_MODULO_RETIROS.TBPKT_INTERFACE_RETIROS.SQL_TIPO_CIERRE",theSqlTS);
   // set IN parameters
   if (v_fecha == null) __sJT_st.setNull(1,oracle.jdbc.OracleTypes.INTEGER); else __sJT_st.setInt(1,v_fecha.intValue());
   __sJT_st.setString(2,v_mensajeLog);
   __sJT_st.setInt(3,v_total_reg);
