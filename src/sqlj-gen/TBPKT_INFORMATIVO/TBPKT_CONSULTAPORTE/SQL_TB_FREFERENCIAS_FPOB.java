...

{
  ...
  try {
   ...
   __sJT_st = __sJT_ec.prepareOracleCall(__sJT_cc,"0TBPKT_INFORMATIVO.TBPKT_CONSULTAPORTE.SQL_TB_FREFERENCIAS_FPOB",theSqlTS);
   if (__sJT_ec.isNew())
   {
   ...
   // set IN parameters
   __sJT_st.setString(2,producto);
   __sJT_st.setString(3,v_sistema);
   __sJT_st.setString(4,v_usuario);
   __sJT_st.setString(5,v_password);
  ...
  // execute statement
   ...
   v_sistema = (String)__sJT_st.getString(3);
   v_usuario = (String)__sJT_st.getString(4);
   v_password = (String)__sJT_st.getString(5);
   v_libreria = (String)__sJT_st.getString(6);
