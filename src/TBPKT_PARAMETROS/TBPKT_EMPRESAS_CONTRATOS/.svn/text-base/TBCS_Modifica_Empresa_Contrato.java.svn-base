...
private String v_nuevaCadena ="";
  ...
  v_Consulta.TBPL_RealizarConexion();
    ...
    /*try{
      ...
      v_declaracion = "UPDATE tbempresas_contratos SET \n"+
                    " emc_ref_condicion = DECODE('"+condempcont+"','null',NULL,UPPER('"+condempcont+"')), \n"+
                    " emc_detalle_condicion = DECODE('"+detcond.trim()+"','',NULL,UPPER('"+detcond+"')) \n"+
  ...
  public String getServletInfo() {
    return "TBPKT_EMPRESAS_CONTRATOS.TBCS_Modifica_Empresa_Contrato Information";
  }
}
