...
public class TBS_PaginaActualizar extends HttpServlet{
 ...
 public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
 {
  ...
  try
  {
   ...
   String v_pintar=    i_pagina.TBFL_CABEZA("Actualización de Contratos","Actualización de Contratos","TBPKT_PARAMETROS.TBPKT_ACTUALIZAR_CONTRATOS.TBS_ActualizarContratos","",true,"modulo_retiros.js","return validar_retiro(this)");
 ...
 {
  String v_pintar=    i_pagina.TBFL_CABEZA ("Actualización de Contratos","Error Actualizar Contratos","","<center>Mensaje de error: "+e+"</center>",false);
  out.println(""+v_pintar+"");
  out.println("<BR>");
