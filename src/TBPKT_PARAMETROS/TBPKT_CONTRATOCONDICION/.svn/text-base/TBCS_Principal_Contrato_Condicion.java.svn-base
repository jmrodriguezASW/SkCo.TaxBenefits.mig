...
public class TBCS_Principal_Contrato_Condicion extends HttpServlet implements SingleThreadModel{
...
private String v_nuevaCadena ="";
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    v_Consulta.TBPL_RealizarConexion();//Realiza la conexion con la base de datos
      ...
      v_dconsulta = "SELECT pro_codigo FROM tbproductos";
    ...
    TBPL_Publicar(v_resultadoconsulta);
      ...
      out.println(STBCL_GenerarBaseHTML.TBFL_CABEZA("Administración de condiciones de penalización para contratos","Administración de condiciones de penalización para contratos", "TBPKT_PARAMETROS.TBPKT_CONTRATOCONDICION.TBCS_ACEM_Contrato_Condicion", "", true, "moduloparametro.js", "return checkrequired(this)"));
  ...
  public String getServletInfo() {
    return "TBPKT_CONTRATOCONDICION.TBCS_Principal_Contrato_Condicion Information";
  }
}
