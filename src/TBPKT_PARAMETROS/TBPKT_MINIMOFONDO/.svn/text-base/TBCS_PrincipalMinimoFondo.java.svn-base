...
public class TBCS_PrincipalMinimoFondo extends HttpServlet implements SingleThreadModel{
...
//------------------------------------------
      ...
      out.println(STBCL_GenerarBaseHTML.TBFL_CABEZA("Administración de porcentajes mínimos por fondo","Administración de porcentajes mínimos por fondo", "TBPKT_PARAMETROS.TBPKT_MINIMOFONDO.TBCS_Minimos_Fondos", "", true));
  ...
  public String getServletInfo() {
    return "TBPKT_MINIMOFONDO.TBCS_PrincipalMinimoFondo Information";
  }
}
