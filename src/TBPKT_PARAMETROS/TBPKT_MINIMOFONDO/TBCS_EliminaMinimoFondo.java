...
public class TBCS_EliminaMinimoFondo extends HttpServlet{
...
private String v_nuevaCadena ="";
  ...
  v_Consulta.TBPL_RealizarConexion();
    ...
    //Sentencias SQL
    v_declaracion = "DELETE tbminimos_fondo WHERE mif_pro_codigo = '"+v_codigo+"' AND mif_ref_fondo = '"+fondo+"'";
  ...
  public String getServletInfo() {
    return "TBPKT_MINIMOFONDO.TBCS_EliminaMinimoFondo Information";
  }
}
