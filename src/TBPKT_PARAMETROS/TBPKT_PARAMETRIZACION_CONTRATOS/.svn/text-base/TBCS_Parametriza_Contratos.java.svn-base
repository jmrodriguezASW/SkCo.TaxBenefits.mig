...
public class TBCS_Parametriza_Contratos extends HttpServlet implements SingleThreadModel{
...
private String v_nuevaCadena ="";
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    v_Consulta.TBPL_RealizarConexion();//Realiza la conexion con la base de datos
     ...
     v_dconsulta = "SELECT distinct(con_pro_codigo) FROM tbcontratos";
    ...
    TBPL_Publicar(v_resultadoconsulta);
      ...
      out.println(STBCL_GenerarBaseHTML.TBFL_CABEZA("Administración contratos","Administración de contratos", "TBPKT_PARAMETROS.TBPKT_PARAMETRIZACION_CONTRATOS.TBCS_CM_Contratos", "", true, "moduloparametro.js", "return checkrequired(this)"));
      ...
      out.println("<TR bgColor=white borderColor=silver><TD width=\"22%\"><FONT color=black face=verdana size=1><B><SUP>*</SUP>Número del contrato:</B></font></TD><TD width=\"22%\"><FONT color=black face=verdana size=1><INPUT TYPE=text NAME=obligatoriocontrato SIZE=12 MAXLENGTH=12></font></TD></TR>");
      out.println("</TABLE>");
      out.println("<font face='Verdana, Arial, Helvetica, sans-serif'><font size='1'>");
      out.println("<BLOCKQUOTE>");
      out.println("<INPUT TYPE=radio NAME=opcion VALUE='v_dconsulta' CHECKED>Consultar contrato<BR>");
      out.println("<INPUT TYPE=radio NAME=opcion VALUE='modifica'>Modificar contrato<BR>");
      out.println("</BLOCKQUOTE>");
      out.println("</font>");
      out.println("<BR>&nbsp;&nbsp;<BR>");
  ...
  public String getServletInfo() {
    return "TBPKT_PARAMETRIZACION_CONTRATOS.TBCS_Parametriza_Contratos Information";
  }
}
