...
public class TBCS_EliminaPrograma extends HttpServlet implements SingleThreadModel{
...
private String v_nuevaCadena ="";
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    if ((v_codigo!=null))
      ...
      //Sentencias SQL
      v_declaracion = "DELETE tbprogramas_parametrizacion WHERE prg_codigo = '"+v_codigo+"'";
  ...
  public String getServletInfo() {
    return "TBPKT_PRODUCTO.TBCS_EliminaPrograma Information";
  }
}
