...
public class TBCS_EliminaConceptoTransaccion extends HttpServlet implements SingleThreadModel{
...
private String v_nuevaCadena ="";
  ...
  //Elimina un concepto transaccion
  //---------------------------------------
  if ((transac!=null)&&(tipotransac!=null)&&(clasetransac!=null))
    {
    //Sentencias SQL
    v_declaracion = "DELETE tbconceptos_transaccion WHERE cot_ref_transaccion = '"+transac+"' AND cot_ref_tipo_transaccion = '"+tipotransac+"' AND cot_ref_clase_transaccion = '"+clasetransac+"'";
  ...
  //Si no elimina con exito mostrara un mensaje
  else
    {
  ...
  out.println(STBCL_GenerarBaseHTML.TBFL_CABEZA("Administración de conceptos de transacciones","Administración de conceptos de transacciones", "", v_resultadodeclaracion.elementAt(0).toString(), false, "moduloparametro.js", "return checkrequired(this)"));
  ...
  public String getServletInfo() {
    return "TBPKT_CONCEPTOTRANSACCION.TBCS_EliminaConceptoTransaccion Information";
  }
}
