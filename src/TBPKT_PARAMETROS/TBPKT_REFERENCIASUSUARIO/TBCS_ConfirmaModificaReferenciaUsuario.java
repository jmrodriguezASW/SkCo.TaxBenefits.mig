...
public class TBCS_ConfirmaModificaReferenciaUsuario extends HttpServlet implements SingleThreadModel{
...
private String v_nuevaCadena ="";
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try{
       ...
       v_titulo = request.getParameter("titulo");
       }
    ...
    TBPL_Publicar(v_resultadodeclaracion);
      ...
      out.println(STBCL_GenerarBaseHTML.TBFL_CABEZA("Administración de referencias de usuario","Administración de referencias de usuario", "TBPKT_PARAMETROS.TBPKT_REFERENCIASUSUARIO.TBCS_ModificaReferenciaUsuario", "", true, "moduloparametro.js", "return checkrequired(this)"));
      //Aqui van los campo que se quieren mostrar
      out.println("<BR>&nbsp;&nbsp;<BR>");
      out.println("<TABLE align=center class=\"td13\" border=0 cellPadding=0 cellSpacing=0>\n"+
                  "<TBODY><TR><TD><CENTER><FONT color=white face=Verdana size=2><B>Modificar referencia de usuario de&nbsp;"+v_titulo+"</B></FONT></CENTER></TD></TR></TBODY></TABLE>");
      ...
      if (v_descripcion.elementAt(0).toString().startsWith("UDE")||v_descripcion.elementAt(0).toString().startsWith("UDS"))
        out.println("<TR bgColor=white borderColor=silver><TD width=\"22%\"><FONT color=black face=verdana size=1><B>Valor:</B></font></TD><TD width=\"22%\"><FONT color=black face=verdana size=1>"+v_descripcion.elementAt(2).toString()+"<INPUT TYPE=hidden NAME=v_dvalor VALUE='"+v_descripcion.elementAt(2).toString()+"'><BR><INPUT TYPE=text NAME=v_valor MAXLENGTH=50 SIZE=50 VALUE='"+v_descripcion.elementAt(2).toString()+"'><BR>Introducir valores entre 0 y 100</font></TD></TR>");
      else
  ...
  public String getServletInfo() {
    return "TBPKT_REFERENCIASUSUARIO.TBCS_ConfirmaModificaReferenciaUsuario Information";
  }
}
