...
public class TBCS_ReferenciasUsuario extends HttpServlet implements SingleThreadModel{
...
//------------------------------------------
      ...
      out.println(STBCL_GenerarBaseHTML.TBFL_CABEZA("Administración de referencias de usuario","Administración de referencias de usuario", "TBPKT_PARAMETROS.TBPKT_REFERENCIASUSUARIO.TBCS_ACEMReferenciasUsuario", "", true, "moduloparametro.js", "return checkrequired(this)"));
