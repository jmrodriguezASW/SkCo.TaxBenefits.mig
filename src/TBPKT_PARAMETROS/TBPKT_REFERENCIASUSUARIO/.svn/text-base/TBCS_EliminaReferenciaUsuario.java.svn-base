...
public class TBCS_EliminaReferenciaUsuario extends HttpServlet implements SingleThreadModel{
...
private String v_nuevaCadena ="";
  ...
  if ((v_codigo!=null))
    ...
    //Sentencias SQL
    v_declaracion = "DELETE tbreferencias WHERE ref_codigo = '"+v_codigo+"'";
  ...
  out.println(STBCL_GenerarBaseHTML.TBFL_CABEZA("Administración de referencias de usuarios","Administración de referenicias de usuario", "", v_resultadodeclaracion.elementAt(0).toString(), false, "moduloparametro.js", "return checkrequired(this)"));
  ...
  public String getServletInfo() {
    return "TBPKT_REFERENCIASUSUARIO.TBCS_EliminaReferenciaUsuario Information";
  }
}
