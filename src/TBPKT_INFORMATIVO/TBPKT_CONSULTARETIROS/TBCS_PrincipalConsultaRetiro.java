...
public class TBCS_PrincipalConsultaRetiro extends HttpServlet {
...
private String v_nuevaCadena ="";
 ...
 //TBCL_Seguridad Seguridad    = new TBCL_Seguridad;
    ...
    TBPL_Publicar(v_resultadoConsulta);
      ...
      out.println(STBCL_GenerarBaseHTML.TBFL_CABEZA("Consulta de retiros","Consulta de retiros", "TBPKT_INFORMATIVO.TBPKT_CONSULTARETIROS.TBCS_ConsultaRetiro", "", true, "moduloparametro.js", "return checkrequired(this)"));
  ...
  public String getServletInfo() {
    return "TBPKT_CONSULTARETIROS.TBCS_PrincipalConsultaRetiro Information";
  }
}
