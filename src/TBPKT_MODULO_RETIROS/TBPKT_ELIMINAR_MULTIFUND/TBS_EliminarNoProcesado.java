...
public class TBS_EliminarNoProcesado extends HttpServlet
{
 ...
 public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
 {
  ...
  try
  {
   ...
   {
    String v_pintarout=    i_pagina.TBFL_CABEZA("Eliminar Solicitud de Retiro No Procesada","Eliminar Solicitud de Retiro No procesada","","<center>Error de comunicación no se tiene conexión con el servidor web,por favor intente de nuevo.</center>",false);
