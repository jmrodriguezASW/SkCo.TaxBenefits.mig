...
public class TBS_EliminarNoProcesado extends HttpServlet
{
 ...
 //TBCL_Seguridad Seguridad    = new TBCL_Seguridad;
   ...
   if((java.lang.String)session.getAttribute("s_producto") != null || (java.lang.String)session.getAttribute("s_contrato")!= null)
   {
    ...
    {
     t_tax.commit();
     String v_pintar=    STBCL_GenerarBaseHTML.TBFL_CABEZA("Eliminar Solicitud de Retiro No Procesada","Eliminar Solicitud de Retiro No procesada","","<center>"+v_mensaje+"</center>",false);
   ...
   {
    String v_pintarout=    STBCL_GenerarBaseHTML.TBFL_CABEZA("Eliminar Solicitud de Retiro No Procesada","Eliminar Solicitud de Retiro No procesada","","<center>Error de comunicación no se tiene conexión con el servidor web,por favor intente de nuevo.</center>",false);
