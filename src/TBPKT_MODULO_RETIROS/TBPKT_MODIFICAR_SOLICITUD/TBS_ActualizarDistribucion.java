 ...
 String v_menex = "";
   ...
   if(ex.equals("java.sql.SQLException: found null connection context"))
   {
    v_menex = "Error de comunicación no se tiene conexión con el servidor web,por favor intente de nuevo.";
     ...
     String v_pintar=    STBCL_GenerarBaseHTML.TBFL_CABEZA ("Modififcar Solicitud de Retiro","Error al Modificar Distribución de Fondos","","<center>"+v_menex+"</center>",false);
