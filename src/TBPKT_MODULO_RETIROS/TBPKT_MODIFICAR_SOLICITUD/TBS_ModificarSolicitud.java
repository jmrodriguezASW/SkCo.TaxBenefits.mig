...
/**Página inicial de modificación de solicitud de retiros,presenta la opción de:
 * -cambiar código de banco y número de cuenta
...
public class TBS_ModificarSolicitud extends HttpServlet implements SingleThreadModel
{
 ...
 public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
 {
  ...
  try
  {
   ...
   //se llama procedimiento que dibuja página de respuesta, que muestra las solicitudes de retiro
   //retiros que se pueden modificar y las diferentes opciones de modificación
